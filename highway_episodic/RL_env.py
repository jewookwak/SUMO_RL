...
class rlEnv():
    ...
    def __init__(self, sumoBinary, net_file: str, cfg_file: str,  veh:str, use_gui: bool = True,
        ...
        self.observation_space = [0, 1, 2, 3, 4, 5, 6] # ego_pos_x, ego_v, ego_lane_num, ego_to_left_spaces, ego_to_right_spaces, left_space_size, right_space_size
        self.sumo =traci
    ...
    def step(self, action): #action-> 0: LK_const_vel, 1: LK_accel, 2: LK_decel, 3: LC_left, 4: LC_right
        ...
        nextstate = []
        reward = 0 # rear vehicle collision : -10,forward vehicle collision : -20, LC_succeed_with_biggest_space : +20, LC_succeed_with_smaller_space : +10, step*-0.01
