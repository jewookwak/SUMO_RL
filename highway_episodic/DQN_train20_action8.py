        ...
        while (env.done) == False:
            ...
            if action == 0 or action == 1 or action == 2 or action ==3 or action ==4 or action == 7:
                ...
                if action==0:
                    ...
                    agent.append_sample7(state, action, reward, next_state, env.done)
                agent.append_sample()
                # 매 타임스텝마다 학습
            ...
            if env.done:
                ...
                if episode == episodenum-1 or (episode+1)%100 ==0:
                    agent.model.save_weights("/home/mds/Desktop/highway_episodic/DQN/save_model20/model", save_format="tf")
                    with open("/home/mds/Desktop/highway_episodic/DQN/save_model20/memory/1/replaybuffer"+str(episode), "wb") as file:
                        pickle.dump(agent.memory, file)
                    with open("/home/mds/Desktop/highway_episodic/DQN/save_model20/memory/1/m0replaybuffer"+str(episode), "wb") as file:
                        pickle.dump(agent.memory0, file)
                    with open("/home/mds/Desktop/highway_episodic/DQN/save_model20/memory/1/m1replaybuffer"+str(episode), "wb") as file:
                        pickle.dump(agent.memory1, file)
                    with open("/home/mds/Desktop/highway_episodic/DQN/save_model20/memory/1/m2replaybuffer"+str(episode), "wb") as file:
                        pickle.dump(agent.memory2, file)
                    with open("/home/mds/Desktop/highway_episodic/DQN/save_model20/memory/1/m3replaybuffer"+str(episode), "wb") as file:
                        pickle.dump(agent.memory3, file)
                    with open("/home/mds/Desktop/highway_episodic/DQN/save_model20/memory/1/m4replaybuffer"+str(episode), "wb") as file:
                        pickle.dump(agent.memory4, file)
                    with open("/home/mds/Desktop/highway_episodic/DQN/save_model20/memory/1/m5replaybuffer"+str(episode), "wb") as file:
                        pickle.dump(agent.memory5, file)
                    with open("/home/mds/Desktop/highway_episodic/DQN/save_model20/memory/1/m6replaybuffer"+str(episode), "wb") as file:
                        pickle.dump(agent.memory6, file)
...
class DQNAgent:
    def __init__(self, state_size, action_size):
        ...
        self.batch_size = 64
        self.train_start = 1000*8

        # 리플레이 메모리, 최대 크기 100
        self.memory = deque(maxlen=5000*8)
    ...
    def append_sample(self):
        if len(self.memory0)>=1000 and len(self.memory1)>=1000 and len(self.memory2)>=1000 and len(self.memory3)>=1000 and len(self.memory4)>=1000 and len(self.memory5)>=1000 and len(self.memory6)>=1000 and len(self.memory7)>=1000:
