...
class rlEnv():
    ...
    def __reward(self, step_num, action):
        ...
        w3 = 0.01*2 # distance to biggest empty space positive reward
        w4 = 0.1*0 # LK continue if rear accel is far away positive reward or if rear accel is closer give negative reward
        w5 = 0.2 # LC succeed positive reward
        reward = 0
        vehs = traci.vehicle.getIDList()
        ###negative rewards            
        #collision
