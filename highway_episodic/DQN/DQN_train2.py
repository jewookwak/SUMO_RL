...
def save_result():
    ...
    path = "/home/mds/Desktop/highway_episodic/DQN/result/"
    os.chdir(path)
    now = datetime.now()
    ...
    for episode in range(episodenum):
        ...
        while (env.done) == False:
            ...
            if env.done:
                ...
                pylab.savefig("/home/mds/Desktop/highway_episodic/DQN/save_graph2/graph.png")

                # 이동 평균이 400 이상일 때 종료
                if score_avg > 400:
                    agent.model.save_weights("/home/mds/Desktop/highway_episodic/DQN/save_model2/model", save_format="tf")
                    sys.exit()
