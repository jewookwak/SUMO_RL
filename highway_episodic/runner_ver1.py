...
params = 'C:/Users/jewoo/OneDrive/바탕 화면/SUMO/highway_episodic/log_data/parameters.csv'
...
def generate_routefile():
    ...
    rand_shift_left =random.uniform(-10,10)
    rand_shift_right =random.uniform(-10,10)
    for i in range(10):
    ...
    with open("highway_episodic.rou.xml", "w") as routes:
        ...
        <vehicle id="ego" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="100" departLane="1" color="0,1,0"/>   
                
        <vehicle id="car.leftrear0" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="""+"\""+str(50+rand[0]+rand_shift_left)+"\""+""" departLane="2" color="1,1,0"/>
        <vehicle id="car.leftrear1" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="""+"\""+str(80+rand[1]+rand_shift_left)+"\""+""" departLane="2" color="1,1,0"/>
        <vehicle id="accel.rear" type="accel_truck" route="route0" depart="0.00" departSpeed="max" departPos="0" departLane="1" color="1,0,0"/>
        <vehicle id="car.rightrear0" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="""+"\""+str(50+rand[2]+rand_shift_right)+"\""+""" departLane="0" color="1,1,0"/> 
        <vehicle id="car.rightrear1" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="""+"\""+str(80+rand[3]+rand_shift_right)+"\""+""" departLane="0" color="1,1,0"/> 
        ...
        <vehicle id="car.leftforward1" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="""+"\""+str(140+rand[5]+rand_shift_left)+"\""+""" departLane="2" color="1,1,0"/>
        <vehicle id="car.leftforward2" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="""+"\""+str(170+rand[6]+rand_shift_left)+"\""+""" departLane="2" color="1,1,0"/>
        <vehicle id="car.forward" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="200" departLane="1" color="1,1,0"/>
        ...
        <vehicle id="car.rightforward1" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="""+"\""+str(140+rand[8]+rand_shift_right)+"\""+""" departLane="0" color="1,1,0"/>
        <vehicle id="car.rightforward2" type="car" route="route0" depart="0.00" departSpeed="avg" departPos="""+"\""+str(170+rand[9]+rand_shift_right)+"\""+""" departLane="0" color="1,1,0"/> 
...
def save_csv():
    ...
    os.chdir('C:/Users/jewoo/OneDrive/바탕 화면/SUMO/highway_episodic/log_data')
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        for veh_id in vehs:
            ...
            if (traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 't'):
                ...
                # if (traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 't'):
                #     if(veh_id[5] =='0'):
                #         if((crossroads_end - traci.vehicle.getPosition(veh_id)[0]) <150):
                #             if(traci.vehicle.getLaneIndex(veh_id) == 3 or traci.vehicle.getLaneIndex(veh_id) == 2):
                #                 traci.vehicle.setLaneChangeMode(veh_id,0b000000001001)
                #                 traci.vehicle.changeLaneRelative(veh_id,-1,5)
                #     elif(veh_id[5] =='1'):
                #          if((crossroads_end - traci.vehicle.getPosition(veh_id)[0]) <150):
                #             if(traci.vehicle.getLaneIndex(veh_id) == 1 or traci.vehicle.getLaneIndex(veh_id) == 0):
                #                 traci.vehicle.setLaneChangeMode(veh_id,0b000000001001)
                #                 traci.vehicle.changeLaneRelative(veh_id,1,5)
            control_input = []
            if ((traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 'c') or veh_id == 'ego'):
                c0 = 1.98
                # tau = 1.36
                ...
                # jerk = 2 # m/s^3
                # dt = step_length
                # a_cur = traci.vehicle.getAccel(veh_id)
                # v_controled = traci.vehicle.getSpeed(veh_id)
                # if traci.vehicle.getLeader(veh_id) is not None:
                #     Leader_id,c_front = traci.vehicle.getLeader(veh_id)
                #     v_preceding= traci.vehicle.getSpeed(Leader_id)
                #     c_desire = c0+tau*v_preceding
                #     # print(veh_id," a_desire : ",a_desire(v_controled,v_preceding,c_desire,c_front))
                #     if(a_cur <= a_desire(v_controled,v_preceding,c_desire,c_front)):
                #         traci.vehicle.setAcceleration(veh_id, a_cur+jerk*dt,0.01)
                #     else:
                #         traci.vehicle.setAcceleration(veh_id, a_cur-jerk*dt,0.01)                    
                # else:
                #     if(a_cur <= a_max(v_controled)):
                #         traci.vehicle.setAcceleration(veh_id, a_cur+jerk*dt,0.01)
                #     else:
                #         traci.vehicle.setAcceleration(veh_id, a_cur-jerk*dt,0.01) 
                ...
                #     # # off ramp lanechange
                #     # if((crossroads_end - traci.vehicle.getPosition(veh_id)[0]) <150):
                #     #     if(traci.vehicle.getLaneIndex(veh_id) == 1 or traci.vehicle.getLaneIndex(veh_id) == 0) and traci.vehicle.getRoadID(veh_id) == 'E5':
                #     #         # print(veh_id, 'off ramp LC')
                #     #         lane_change_to_left(veh_id)
                #     follower_id, bac_x = traci.vehicle.getFollower(veh_id)
                #     if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #         if(follower_id[0] == 't' or follower_id[0] =='a'):                                                            
                #             relative_v = (traci.vehicle.getSpeed(follower_id) - traci.vehicle.getSpeed(veh_id))
                #             ID = veh_id.split('.')
                #             if not (len(car0_buffer[int(ID[1])])==0) and car0_buffer[int(ID[1])][-1][17] is not None:
                #                 relative_a = (relative_v  - car0_buffer[int(ID[1])][-1][17])/step_length
                #                  # print(veh_id, 'follower : ',follower_id, 'bac_x : ',bac_x, 'relative_v : ',relative_v, 'relative_a : ',relative_a)
                #     #mode change   
                #     if car0_mode[int(veh_id[5:])] == 0: #cruise mode
                #         # traci.vehicle.setSpeedMode(veh_id,0b011111)
                #         traci.vehicle.setLaneChangeMode(veh_id,0b011001010101)
                #         if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #             if(follower_id[0] == 't' or follower_id[0] =='a'):
                #                 if(relative_v >=0 and bac_x <=20 and relative_a>=-20 and relative_a<=20 and traci.vehicle.getRoadID(follower_id) == 'E5'):
                #                     answer =svc_RBF_3d.predict([[bac_x,relative_v,relative_a]]) 
                #                     print(veh_id, 'follower : ',follower_id, 'bac_x : ',bac_x, 'relative_v : ',relative_v, 'relative_a : ',relative_a)
                #                     print(veh_id," bac_x : ",bac_x)
                #                     if(answer[0] == 1):
                #                         car0_mode[int(veh_id[5:])] = 1 #anti-rear collision mode
                #                         print(veh_id," change to anti-RVC mode")
                                        
                #     elif car0_mode[int(veh_id[5:])] == 1: #anti-rear collision mode
                #         # print(veh_id, ' avoid cruise mode')
                #         traci.vehicle.setLaneChangeMode(veh_id,0b000000001001)
                #         ## checking the lane so which lane is moveable.
                #         if (traci.vehicle.getRoadID(veh_id) == 'E5'):
                #             if(Lane_has_changed(veh_id) ==True):
                #                 car0_mode[int(veh_id[5:])] =0
                #                 avoiding_LC=avoiding_LC+1
                #                 print("avoiding_LC : ",avoiding_LC)
                #             if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #                 if(Back_Car_has_changed(veh_id) == True):
                #                     car0_mode[int(veh_id[5:])] =0
                #             else:
                #                 car0_mode[int(veh_id[5:])] =0
                #                 # print("NO BACK VEHICLE")

                #             if(traci.vehicle.getLaneIndex(veh_id) ==3):
                #                 avoiding_motion_plan(veh_id,'left')
                #             elif(traci.vehicle.getLaneIndex(veh_id) ==2):
                #                 avoiding_motion_plan(veh_id,'none')
                #             elif(traci.vehicle.getLaneIndex(veh_id) ==1):
                #                 avoiding_motion_plan(veh_id,'none')
                #             elif(traci.vehicle.getLaneIndex(veh_id) ==0):
                #                 avoiding_motion_plan(veh_id,'right')
                #             if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #                 if(traci.vehicle.getSpeed(follower_id)<= traci.vehicle.getSpeed(veh_id) and traci.vehicle.getAcceleration(veh_id)>=0 and traci.vehicle.getAcceleration(follower_id)<=0): #Impossible conflict with each other condition.
                #                     car0_mode[int(veh_id[5:])] = 0 #change to cruise
                #                     print(veh_id," change to cruise mode")

                # elif(veh_id[3] == '1'):
                #     #  # off ramp lanechange 
                #     # if((crossroads_end - traci.vehicle.getPosition(veh_id)[0]) <150):
                #     #     if(traci.vehicle.getLaneIndex(veh_id) == 2 or traci.vehicle.getLaneIndex(veh_id) == 3):
                #     #         # print(veh_id, 'off ramp LC')
                #     #         lane_change_to_right(veh_id)
                #     follower_id, bac_x = traci.vehicle.getFollower(veh_id)
                #     if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #         if(follower_id[0] == 't' or follower_id[0] =='a'):
                #             relative_v = (traci.vehicle.getSpeed(follower_id) - traci.vehicle.getSpeed(veh_id))
                #             ID = veh_id.split('.')
                #             if not (len(car1_buffer[int(ID[1])])==0) and car1_buffer[int(ID[1])][-1][17] is not None:
                #                 relative_a = (relative_v  - car1_buffer[int(ID[1])][-1][17])/step_length
                #                 # print(veh_id, 'follower : ',follower_id, 'bac_x : ',bac_x, 'relative_v : ',relative_v, 'relative_a : ',relative_a)
                #     # mode   
                #     if car1_mode[int(veh_id[5:])] == 0: #cruise mode
                #         # traci.vehicle.setSpeedMode(veh_id,0b011111)
                #         traci.vehicle.setLaneChangeMode(veh_id,0b011001010101)
                #         if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #             if(follower_id[0] == 't' or follower_id[0] =='a'):
                ...
                #                     print(veh_id," bac_x : ",bac_x)
                #                     if(answer[0] == 1):
                #                         car1_mode[int(veh_id[5:])] = 1 #change to anti-rear collision mode
                #                         print(veh_id," change to anti-RVC mode")

                #     elif car1_mode[int(veh_id[5:])] == 1: #anti-rear collision mode
                #         # print(veh_id, ' avoid cruise mode')
                #         traci.vehicle.setLaneChangeMode(veh_id,0b000000001001)
                #         ## checking the lane so which lane is moveable.
                #         if (traci.vehicle.getRoadID(veh_id) == 'E5'):
                #             if(Lane_has_changed(veh_id) ==True):
                #                 car1_mode[int(veh_id[5:])] =0
                #                 avoiding_LC=avoiding_LC+1
                #                 print("avoiding_LC : ",avoiding_LC)
                #             if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #                 if(Back_Car_has_changed(veh_id) == True):
                ...
                #             if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #                 if(traci.vehicle.getSpeed(follower_id)<= traci.vehicle.getSpeed(veh_id) and traci.vehicle.getAcceleration(veh_id)>=0 and traci.vehicle.getAcceleration(follower_id)<=0): #Impossible conflict with each other condition.
                #                     car1_mode[int(veh_id[5:])] = 0 #change to cruise
                #                     print(veh_id," change to cruise mode")
                ...
                #             if not (len( [int(ID[1])])==0) and car2_buffer[int(ID[1])][-1][17] is not None:
                #                 relative_a = (relative_v  - car2_buffer[int(ID[1])][-1][17])/step_length
                #                 # print(veh_id, 'follower : ',follower_id, 'bac_x : ',bac_x, 'relative_v : ',relative_v, 'relative_a : ',relative_a)
                #     #mode   
                #     if car2_mode[int(veh_id[5:])] == 0: #cruise mode
                #         # traci.vehicle.setSpeedMode(veh_id,0b011111)
                #         traci.vehicle.setLaneChangeMode(veh_id,0b011001010101)
                #         if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #             if(follower_id[0] == 't' or follower_id[0] =='a'):
                ...
                #                     print(veh_id," bac_x : ",bac_x)
                #                     if(answer[0] == 1):
                #                         car2_mode[int(veh_id[5:])] = 1 #change to anti-rear collision mode
                #                         print(veh_id," change to anti-RVC mode")
                #     elif car2_mode[int(veh_id[5:])] == 1: #anti-rear collision mode
                #         # print(veh_id,' avoid cruise mode')
                #         traci.vehicle.setLaneChangeMode(veh_id,0b000000001001)
                #         ## checking the lane so which lane is moveable.
                #         if (traci.vehicle.getRoadID(veh_id) == 'E5'):
                #             if(Lane_has_changed(veh_id) ==True):
                #                 car2_mode[int(veh_id[5:])] =0
                #                 avoiding_LC=avoiding_LC+1
                #                 print("avoiding_LC : ",avoiding_LC)
                #             if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #                 if(Back_Car_has_changed(veh_id) == True):
                ...
                #             if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #                 if(traci.vehicle.getSpeed(follower_id)<= traci.vehicle.getSpeed(veh_id) and traci.vehicle.getAcceleration(veh_id)>=0 and traci.vehicle.getAcceleration(follower_id)<=0): #Impossible conflict with each other condition.
                #                     car2_mode[int(veh_id[5:])] = 0 #change to cruise
                #                     print(veh_id," change to cruise mode")
                ...
                #             relative_v = (traci.vehicle.getSpeed(follower_id) - traci.vehicle.getSpeed(veh_id))
                #             ID = veh_id.split('.')
                #             if not (len(car3_buffer[int(ID[1])])==0) and car3_buffer[int(ID[1])][-1][17] is not None:
                #                 relative_a = (relative_v  - car3_buffer[int(ID[1])][-1][17])/step_length
                                
                #     # mode      
                #     if car3_mode[int(veh_id[5:])] == 0: #cruise mode
                #         # traci.vehicle.setSpeedMode(veh_id,0b011111)
                #         traci.vehicle.setLaneChangeMode(veh_id,0b011001010101)
                #         if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #             if(follower_id[0] == 't' or follower_id[0] =='a'):
                ...
                #                     print(veh_id, 'follower : ',follower_id, 'bac_x : ',bac_x, 'relative_v : ',relative_v, 'relative_a : ',relative_a)
                #                     if(answer[0] == 1):
                #                         car3_mode[int(veh_id[5:])] = 1 #change to anti-rear collision mode
                #                         print(veh_id," change to anti-RVC mode")
                                        

                #     elif car3_mode[int(veh_id[5:])] == 1: #anti-rear collision mode
                #         # print(veh_id,' avoid cruise mode')
                #         traci.vehicle.setLaneChangeMode(veh_id,0b000000001001)
                #         ## checking the lane so which lane is moveable.
                #         if (traci.vehicle.getRoadID(veh_id) == 'E5'):
                #             if(Lane_has_changed(veh_id) ==True):
                #                 car3_mode[int(veh_id[5:])] =0
                #                 avoiding_LC=avoiding_LC+1
                #                 print("avoiding_LC : ",avoiding_LC)
                #             if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #                 if(Back_Car_has_changed(veh_id) == True):
                ...
                #             if type(traci.vehicle.getFollower(veh_id)) is not None and traci.vehicle.getFollower(veh_id)[0] != '':
                #                 if(traci.vehicle.getSpeed(follower_id)<= traci.vehicle.getSpeed(veh_id) and traci.vehicle.getAcceleration(veh_id)>=0 and traci.vehicle.getAcceleration(follower_id)<=0): #Impossible conflict with each other condition.
                #                     car3_mode[int(veh_id[5:])] = 0 #change to cruise
                #                     print(veh_id," change to cruise mode")
            for i in range(20): 
            ...
            for i in range(20): # lane_buffer
                if(veh_id == 'car0.'+str(i)):
                    lane_buffer_car0[i] = traci.vehicle.getLaneIndex('car0.'+str(i))
                    if traci.vehicle.getFollower('car0.'+str(i)) is not None and traci.vehicle.getFollower('car0.'+str(i))[0] != '':
                        back_buffer_car0[i] = traci.vehicle.getFollower('car0.'+str(i))[0]
                if(veh_id == 'car1.'+str(i)): 
                    lane_buffer_car1[i] = traci.vehicle.getLaneIndex('car1.'+str(i))
                    if traci.vehicle.getFollower('car1.'+str(i)) is not None and traci.vehicle.getFollower('car1.'+str(i))[0] != '':
                        back_buffer_car1[i] = traci.vehicle.getFollower('car1.'+str(i))[0]
                if(veh_id == 'car2.'+str(i)): 
                    lane_buffer_car2[i] = traci.vehicle.getLaneIndex('car2.'+str(i))
                    if traci.vehicle.getFollower('car2.'+str(i)) is not None and traci.vehicle.getFollower('car2.'+str(i))[0] != '':
                        back_buffer_car2[i] = traci.vehicle.getFollower('car2.'+str(i))[0]
                if(veh_id == 'car3.'+str(i)):
                    lane_buffer_car3[i] = traci.vehicle.getLaneIndex('car3.'+str(i))   
                    if traci.vehicle.getFollower('car3.'+str(i)) is not None and traci.vehicle.getFollower('car3.'+str(i))[0] != '':
                        back_buffer_car3[i] = traci.vehicle.getFollower('car3.'+str(i))[0]

            if (traci.vehicle.getRoadID(veh_id) == 'E6' and veh_id[0] == 'c') or (traci.vehicle.getRoadID(veh_id) == 'E8' and veh_id[0] == 'c'):
                # traci.vehicle.setSpeedMode(veh_id,0b011111)
                traci.vehicle.setLaneChangeMode(veh_id,0b011001010101)

            
            # if (traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 'a') or (traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 't'):
            if (traci.vehicle.getRoadID(veh_id) == 'E5'):
                if veh_id[0] == 'a' or  veh_id[0] =='t':
                    if((crossroads_end - traci.vehicle.getPosition(veh_id)[0]) <=0):
                        traci.vehicle.remove(veh_id,4)
                        finish_truck = finish_truck+1
                        print('finish truck count : ',finish_truck)
                elif veh_id[0] =='c':
                    if((crossroads_end - traci.vehicle.getPosition(veh_id)[0]) <=0):
                        traci.vehicle.remove(veh_id,4)
        # lane_buffer_ego = traci.vehicle.getLaneIndex('ego') # ego_car lane buffer   # ego_car lane buffer  
        if(end_flag):
            break
    if not end_flag:
        traci.close()
...
if __name__ == "__main__":
    ...
    import sumolib
    traci.start([sumolib.checkBinary("sumo-gui"),"-c", "highway_episodic.sumocfg",
             '--start','true',
             '--gui-settings-file','C:/Users/jewoo/OneDrive/바탕 화면/SUMO/highway_episodic/viewsettings.xml',
