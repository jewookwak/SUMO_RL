...
class DQN(tf.keras.Model):
    def __init__(self, action_size,state_size,batch_size,sequence_length):
        ...
        self.lstm = LSTM(32, batch_input_shape=(batch_size,sequence_length,state_size),return_sequences=False)
...
class DQNAgent:
    def __init__(self, state_size, action_size): 
        ...
        self.model.load_weights("/home/mds/Desktop/highway_episodic/DQN/RL_validation/save_model/space1_target_model2/best_model")
