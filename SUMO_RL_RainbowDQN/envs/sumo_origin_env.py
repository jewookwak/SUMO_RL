...
class rlEnv():
    ...
    def save_action_csv(self,episode,name):
        ...
        file_path = 'logs/results/'+name+'/action/'
...
########################################################
    ...
    def stanley(self,coef,heading_angle,x_cur,v_cur): #heading_angle(degree)
        if coef == [0,0,0,0]:
            ...
            # pylab.xlabel("step")
            # pylab.ylabel("error")
            # pylab.savefig("/home/jewoo/Desktop/highway_episodic/DQN/RL_validation/stanley_graph/stanley_error_graph.png")
            # pylab.clf()
            ...
            # pylab.xlabel("step")
            # pylab.ylabel("error")
            # pylab.savefig("/home/jewoo/Desktop/highway_episodic/DQN/RL_validation/stanley_graph/delta_term_graph.png")
            # pylab.clf()
