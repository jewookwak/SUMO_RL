...
class testEnv():
    ...
    def reset(self):
        ...
        #initiate values of class testEnv.
        testEnv.Rule_RL = []
        testEnv.last_state =[]
        testEnv.lane_buffer_ego = 0
        testEnv.ego_LC_success = False
        testEnv.ego_LC_start = False
        testEnv.ego_LC_completed = False
        testEnv.last_Space1=0
        testEnv.last_Space2=0
        testEnv.last_Space3=0
        testEnv.last_Space4=0
        testEnv.last_safe_Space1=0
        testEnv.last_safe_Space2=0
        testEnv.last_safe_Space3=0
        testEnv.last_safe_Space4=0
        testEnv.S=[0,0,0,0,0,0,0,0,0]
        testEnv.ego_at_Target=[0,0,0,0]
        testEnv.integral_clearance_e=[0,0,0,0,0]
        testEnv.integral_velocity_e=[0,0,0,0,0]
        testEnv.pre_error_clearance = [0,0,0,0,0]
        testEnv.pre_error_velocity = [0,0,0,0,0]
        testEnv.ego_control=[]
        testEnv.ego=[]
        testEnv.left0=[]
        testEnv.left1=[]
        ...
        testEnv.Target3=[]
        testEnv.Target4=[]
        testEnv.Target_left_car = ""
        testEnv.Target_right_car =""
        testEnv.last_action = [[0,0]]
        testEnv.Left_action = False
        testEnv.Right_action = False
        testEnv.rewards =[]
        testEnv.toward_space_reward=[]
        testEnv.toward_space_reward_long=[]
        testEnv.toward_space_reward_lat=[]
        testEnv.t_LC_start =0
        testEnv.initial_x = 0
        testEnv.initial_y = 0
        testEnv.initial_target_y =0
        testEnv.theta_i=0
        testEnv.final_x =9999
        testEnv.final_y = 0
        testEnv.step_num = 0
        testEnv.coefficient=[0,0,0,0]
        testEnv.x_final = 0
        testEnv.crosstrack_error_term=[]
        testEnv.heading_error_term=[]
        testEnv.delta_term = []
        testEnv.clearance_error_term =[]
        testEnv.velocity_error_term = []    
        testEnv.Time=[]
        testEnv.Right_SD = False
        testEnv.Left_SD = False
        testEnv.Front_SD = True
        testEnv.last_target_space =[0,0]
        testEnv.last_vehicles = ['','']
        testEnv.mode=[0,0,0,0,0,0]
        testEnv.vehicles_tau=[random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2]),random.choice([1,1.5,2])]
        # testEnv.vehicles_tau=[random.randint(round(0.74),int(2.27)),random.randint(round(0.74),int(2.27)),0.74,0.74,random.randint(round(0.74),int(2.27)),random.randint(round(0.74),int(2.27)),random.randint(round(0.74),int(2.27)),random.randint(round(0.74),int(2.27)),random.randint(round(0.74),int(2.27)),random.randint(round(0.74),int(2.27)),random.randint(round(0.74),int(2.27)),0.74,0.74,0.74,0.74,0.74,0.74]
        # testEnv.vehicles_tau=[0.74]*20 ########### RL 검증
        # testEnv.tau_random = [random.randint(0,1),random.randint(0,1),random.randint(0,1),random.randint(0,1),random.randint(0,1),random.randint(0,1),random.randint(0,1),random.randint(0,1)]
        testEnv.tau_random = [1]*8 ########### RL 검증
        testEnv.rearMaxSpeed = random.randint(int(29.17),int(33.33))
        # testEnv.rear_collision_mode =  random.randint(0, 1)
        testEnv.rear_collision_mode =  1 ########### RL 검증
        testEnv.rear_tau_aggresive = round(random.uniform(0.1, 0.5),1)
        testEnv.rear_tau_safe = round(random.uniform(0.75, 2.75),1)
        testEnv.rear_sleep =  random.randint(0, 1)
        testEnv.None_collision = True
        # if self.episode!=0: 
        #     self.sumo.close()
        #     sys.stdout.flush()
    ...
    def save_action_csv(self,episode,name):
        ...
        df_ego_action = pd.DataFrame(testEnv.last_action,columns=col_action)
    ...
    def save_csv(self,episode,name):
        ...
        df_ego = pd.DataFrame(testEnv.ego,columns=col)
        df_rear = pd.DataFrame(testEnv.rear,columns=col)
        df_forward = pd.DataFrame(testEnv.forward,columns=col)
        df_left0 = pd.DataFrame(testEnv.left0,columns=col)
        df_left1 = pd.DataFrame(testEnv.left1,columns=col)
        df_left2 = pd.DataFrame(testEnv.left2,columns=col)
        df_left3 = pd.DataFrame(testEnv.left3,columns=col)
        df_left4 = pd.DataFrame(testEnv.left4,columns=col)
        df_left5 = pd.DataFrame(testEnv.left5,columns=col)
        df_left6 = pd.DataFrame(testEnv.left6,columns=col)
        df_left7 = pd.DataFrame(testEnv.left7,columns=col)
        df_right0 = pd.DataFrame(testEnv.right0,columns=col)
        df_right1 = pd.DataFrame(testEnv.right1,columns=col)
        df_right2 = pd.DataFrame(testEnv.right2,columns=col)
        df_right3 = pd.DataFrame(testEnv.right3,columns=col)
        df_right4 = pd.DataFrame(testEnv.right4,columns=col)
        df_right5 = pd.DataFrame(testEnv.right5,columns=col)
        df_right6 = pd.DataFrame(testEnv.right6,columns=col)
        df_right7 = pd.DataFrame(testEnv.right7,columns=col)
        df_target1 = pd.DataFrame(testEnv.Target1,columns=col_target)
        df_target2 = pd.DataFrame(testEnv.Target2,columns=col_target)
        df_target3 = pd.DataFrame(testEnv.Target3,columns=col_target)
        df_target4 = pd.DataFrame(testEnv.Target4,columns=col_target)
        df_ego_control = pd.DataFrame(testEnv.ego_control,columns=col_control)
        df_ego_action = pd.DataFrame(testEnv.last_action,columns=col_action)
        df_reward = pd.DataFrame(testEnv.rewards,columns=col_reward)
        df_space_reward = pd.DataFrame(testEnv.toward_space_reward,columns=col_space_reward)
        df_space_reward_long = pd.DataFrame(testEnv.toward_space_reward_long,columns=col_space_reward)
        df_space_reward_lat = pd.DataFrame(testEnv.toward_space_reward_lat,columns=col_space_reward)
    ...
    def __ego_vehicle_LC_start(self):
        ...
        if 'ego' in vehs:
            ...
            last_lane = testEnv.lane_buffer_ego
    ...
    def __get_a_x(self,id):
        dt = self.step_length
        if(len(testEnv.ego)!=0):
            v_x_cur = (traci.vehicle.getPosition(id)[0] - testEnv.ego[-1][2])/dt
            a_x_cur = (v_x_cur -testEnv.ego[-1][4])/dt
        else:
            v_x_cur=0
            a_x_cur=0
        return a_x_cur
    ...
    def __get_a_y(self,id):
        dt = self.step_length
        if(len(testEnv.ego)!=0):
            v_y_cur = (traci.vehicle.getPosition(id)[1] - testEnv.ego[-1][3])/dt
            a_y_cur = (v_y_cur -testEnv.ego[-1][5])/dt
        else:
            v_y_cur=0
            a_y_cur=0
        return a_y_cur
    ...
    def __set_a_y_possible(self,id,a_y_des): #id =='ego'
        ...
        if(len(testEnv.ego)!=0):
            v_y_cur = (traci.vehicle.getPosition(id)[1] - testEnv.ego[-1][3])/dt
            a_y_cur = (v_y_cur -testEnv.ego[-1][5])/dt
            # print("testEnv.ego[-1][5]): ",testEnv.ego[-1][5])
            # print("testEnv.ego[-1][3]: ",testEnv.ego[-1][3])
        else:
            v_y_cur=0
            a_y_cur=0
        #     print("testEnv.ego[-1][5]): None")
        #     print("testEnv.ego[-1][3]: None")
        ...
        if 'ego' in vehs:
            ...
            if lane == 0 and LLP <0:
                if action == 5:
                    ...
                    traci.vehicle.unsubscribeContext(str(id), tc.CMD_GET_VEHICLE_VARIABLE, 300.0)
                    testEnv.last_target_space =left_target_space
                    testEnv.last_vehicles =vehicles
                    ...
                    print("Wrong action!!")
                    traci.vehicle.unsubscribeContext(str(id), tc.CMD_GET_VEHICLE_VARIABLE, 300.0)
                    testEnv.last_target_space =right_target_space
                    testEnv.last_vehicles =vehicles
                    return right_target_space, vehicles
                else:
                    traci.vehicle.unsubscribeContext(str(id), tc.CMD_GET_VEHICLE_VARIABLE, 300.0)
                    return testEnv.last_target_space , testEnv.last_vehicles
    ...
    #     x_t += testEnv.ego[-1][3] - testEnv.ego[-2][3]
    ...
    def __ego_a_desire(self, v_c,v_t,c_d,c,space_num): # desire acceleration by ACC, v_c : ego_vehicle's velocity, v_t : target velocity, c_d : desire clearance, c = actual clearance
        ...
        Kd = 0.005
        Kd2 = 0.7
        testEnv.integral_clearance_e[space_num] += Ki*(c_d -c)*self.step_length
        testEnv.integral_velocity_e[space_num] += Ki2*(v_t-v_c)*self.step_length

        clearance_error = (c_d -c)
        velocity_error = (v_t-v_c)
        if len(testEnv.pre_error_velocity)>0 and len(testEnv.pre_error_velocity)>0:
            a_d = -P*self.__K1(v_c)*(c_d-c) - P2*self.__K2(v_c)*(v_t-v_c) -testEnv.integral_clearance_e[space_num] +testEnv.integral_velocity_e[space_num] -Kd*(clearance_error-testEnv.pre_error_clearance[space_num])/self.step_length +Kd2*(velocity_error-testEnv.pre_error_velocity[space_num])
        else:
            a_d = -P*self.__K1(v_c)*(c_d-c) - P2*self.__K2(v_c)*(v_t-v_c) -testEnv.integral_clearance_e[space_num] +testEnv.integral_velocity_e[space_num]
        ...
        if(a_d >3):
            ...
            return -5
        testEnv.pre_error_clearance[space_num] = (c_d -c)
        testEnv.pre_error_velocity[space_num] = (v_t-v_c)
    ...
    def __ego_a_desire2(self, v_c,v_t,c_d,c,space_num): # desire acceleration by ACC, v_c : ego_vehicle's velocity, v_t : target velocity, c_d : desire clearance, c = actual clearance
        ...
        # print('ego_v: ',v_c)
        # print('target_v: ',v_t)
        testEnv.clearance_error_term.append(-P*self.__K1(v_c)*(c_d-c))
        testEnv.velocity_error_term.append(-P2*self.__K2(v_c)*(v_t-v_c))
        testEnv.Time.append(traci.simulation.getTime())
        # plt.figure(1,figsize=(8,4))            
        # pylab.plot(testEnv.Time, testEnv.clearance_error_term, 'r',label='c_error_term')
        # pylab.plot(testEnv.Time, testEnv.velocity_error_term, 'b',label='vel_error_term')
    ...
    def __rear_vehicle_random_collsion(self, veh_id):
        ...
        # testEnv.rear_collision_mode = self.episode%2
        # 색상 설정
        if testEnv.rear_collision_mode == 1:  # 충돌 모드
            # 빨간색 계열
        ...
        if 'ego' in vehs:  # 선행 차량이 있을 때 ACC
            ...
            if testEnv.rear_collision_mode == 1:  # 충돌 모드
                # 위험한 tau 값 (0.1~0.5초)
                tau = testEnv.rear_tau_aggresive
                # 충돌 가능성 높은 차량은 로깅
                # print(f"[위험] 차량 {veh_id} - 충돌 모드, tau: {tau:.2f}초, 간격: {c_front:.2f}m")
                
            else:  # 안전 모드
                # 안전한 tau 값 (1.5~2.5초)
                tau = testEnv.rear_tau_safe
                # 안전 모드 차량 로깅
            ...
            # 비충돌 모드일 경우 감속 강화
            if testEnv.rear_collision_mode == 0 and time_to_collision < 2.0 and a_des<0:
                a_des = -9  # 풀브레이킹

             # 충돌 모드일 경우 감속 약화 (더 공격적인 주행)
            if testEnv.rear_collision_mode == 1 and a_des < 0:
                if testEnv.rear_sleep == 1:
                    a_des = 0
                else:
    ...
    def __set_ego_a_movetoXY(self,id,a_des): #return 값은 jerk 값을 고려한 현실적인 가속도 값을 반환한다. # SUMO에 가속도를 입력한다.
        ...
        if len(testEnv.ego)!=0:
            last_x = testEnv.ego[-1][2]
            last_y = testEnv.ego[-1][3]
            v_y_cur = (traci.vehicle.getPosition(id)[1] - testEnv.ego[-1][3])/dt
            a_y_cur = (v_y_cur -testEnv.ego[-1][5])/dt
        else:
            last_x = x_cur
        ...
        # print('y_cur: ',y_cur)
        # if len(testEnv.ego) != 0:
        #     if testEnv.ego[-1][8]<90:
        #         angle = testEnv.ego[-1][8] +4*dt
        #     elif testEnv.ego[-1][8]>90:
        #         angle = testEnv.ego[-1][8] -4*dt
        #     else:
        #         angle =90
        # else:
...
########################################################
        ...
        if(a_cur+jerk*dt<a_des):
            ...
            x_next = x_cur +v_next*dt 
            # return a_des
        # theta = np.arctan2(y_cur-testEnv.ego[-1][3],x_cur-testEnv.ego[-1][2])
        # if(y_cur-testEnv.ego[-1][3]>=0):
        #     angle = 90-theta*30
        # else:
        #     angle = 90-theta*30
        # print("angle:::::::::::::::::",angle)
    ...
    def __set_ego_a_movetoXY2(self,id,a_des,action): #return 값은 jerk 값을 고려한 현실적인 가속도 값을 반환한다. # SUMO에 가속도를 입력한다.
        ...
        if action == 1  and lane == 2 and x_cur > traci.vehicle.getPosition(testEnv.Target_left_car)[0] + epsilon_d:
            target_lane_y = -1.6
        if action == 3 and lane == 2 and x_cur < traci.vehicle.getPosition(testEnv.Target_left_car)[0] - epsilon_d:
            target_lane_y = -1.6
        if action == 2 and lane == 0 and x_cur > traci.vehicle.getPosition(testEnv.Target_right_car)[0] + epsilon_d:
            target_lane_y = -8
        if action == 4 and lane == 0 and x_cur < traci.vehicle.getPosition(testEnv.Target_right_car)[0] - epsilon_d:
            target_lane_y = -8
...
########################################################
    ...
    def state(self,id = 'ego'):
        states = []
        vehs = traci.vehicle.getIDList()
        if id in vehs and testEnv.Target_left_car in vehs and testEnv.Target_right_car in vehs:
            if traci.vehicle.getLeader(testEnv.Target_left_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==2:
                left_leader = traci.vehicle.getLeader('ego')[0]
            elif traci.vehicle.getLeader(testEnv.Target_left_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==1:
                left_leader = 'car.left'+str(int(testEnv.Target_left_car[-1])+1)
            else:
                left_leader = traci.vehicle.getLeader(testEnv.Target_left_car)[0]
            if traci.vehicle.getFollower(testEnv.Target_left_car)[0] =='ego' and traci.vehicle.getLaneIndex('ego')==2:
                left_follower = traci.vehicle.getFollower('ego')[0]
            elif traci.vehicle.getFollower(testEnv.Target_left_car)[0] =='ego' and traci.vehicle.getLaneIndex('ego')==1:
                left_follower = 'car.left'+str(int(testEnv.Target_left_car[-1])-1)
            else:
                left_follower = traci.vehicle.getFollower(testEnv.Target_left_car)[0]
            
            if traci.vehicle.getLeader(testEnv.Target_right_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==0:
                right_leader = traci.vehicle.getLeader('ego')[0]
            elif traci.vehicle.getLeader(testEnv.Target_right_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==1:
                right_leader = 'car.right'+str(int(testEnv.Target_right_car[-1])+1)
            else:
                right_leader = traci.vehicle.getLeader(testEnv.Target_right_car)[0]
            if traci.vehicle.getFollower(testEnv.Target_right_car)[0] =='ego' and traci.vehicle.getLaneIndex('ego')==0:
                right_follower = traci.vehicle.getFollower('ego')[0]
            elif traci.vehicle.getFollower(testEnv.Target_right_car)[0] =='ego' and traci.vehicle.getLaneIndex('ego')==1:
                right_follower = 'car.right'+str(int(testEnv.Target_right_car[-1])-1)
            else:
                right_follower = traci.vehicle.getFollower(testEnv.Target_right_car)[0]
            ...
            # if rear_rel_x == None and len(testEnv.rear) !=0:
            #     for sublist in reversed(testEnv.rear):
            #         if sublist[2] == None:
            #             pass
            #         else:
            ...
            left_rel_x, left_rel_y = np.asarray(traci.vehicle.getPosition(testEnv.Target_left_car)) - np.asarray(traci.vehicle.getPosition('ego'))
            left_v = traci.vehicle.getSpeed(testEnv.Target_left_car)
            ...
            right_rel_x, right_rel_y = np.asarray(traci.vehicle.getPosition(testEnv.Target_right_car)) - np.asarray(traci.vehicle.getPosition('ego'))
            right_v = traci.vehicle.getSpeed(testEnv.Target_right_car)
            ...
            s1_rel_x, s1_rel_y = ((traci.vehicle.getPosition(testEnv.Target_left_car)[0] + traci.vehicle.getPosition(left_leader)[0])/2 - traci.vehicle.getPosition('ego')[0]), (traci.vehicle.getPosition(testEnv.Target_left_car)[1]- traci.vehicle.getPosition('ego')[1])
            s1_v = (traci.vehicle.getSpeed(testEnv.Target_left_car) + traci.vehicle.getSpeed(left_leader))/2
            s2_rel_x, s2_rel_y = ((traci.vehicle.getPosition(testEnv.Target_right_car)[0] + traci.vehicle.getPosition(right_leader)[0])/2 - traci.vehicle.getPosition('ego')[0]), (traci.vehicle.getPosition(testEnv.Target_right_car)[1]- traci.vehicle.getPosition('ego')[1])
            s2_v = (traci.vehicle.getSpeed(testEnv.Target_right_car) + traci.vehicle.getSpeed(right_leader))/2
            s3_rel_x, s3_rel_y = ((traci.vehicle.getPosition(testEnv.Target_left_car)[0] + traci.vehicle.getPosition(left_follower)[0])/2 - traci.vehicle.getPosition('ego')[0]), (traci.vehicle.getPosition(testEnv.Target_left_car)[1]- traci.vehicle.getPosition('ego')[1])
            s3_v = (traci.vehicle.getSpeed(testEnv.Target_left_car) + traci.vehicle.getSpeed(left_follower))/2
            s4_rel_x, s4_rel_y = ((traci.vehicle.getPosition(testEnv.Target_right_car)[0] + traci.vehicle.getPosition(right_follower)[0])/2 - traci.vehicle.getPosition('ego')[0]), (traci.vehicle.getPosition(testEnv.Target_right_car)[1]- traci.vehicle.getPosition('ego')[1])
            s4_v = (traci.vehicle.getSpeed(testEnv.Target_right_car) + traci.vehicle.getSpeed(right_follower))/2
            ...
            space1_size = np.abs((traci.vehicle.getPosition(testEnv.Target_left_car)[0] - traci.vehicle.getPosition(left_leader)[0]))
            space2_size = np.abs((traci.vehicle.getPosition(testEnv.Target_right_car)[0] - traci.vehicle.getPosition(right_leader)[0]))
            space3_size = np.abs((traci.vehicle.getPosition(testEnv.Target_left_car)[0] - traci.vehicle.getPosition(left_follower)[0]))
            space4_size = np.abs((traci.vehicle.getPosition(testEnv.Target_right_car)[0] - traci.vehicle.getPosition(right_follower)[0]))
    ...
    def __toward_empty_space_reward(self, id, action):
        ...
        def reward_for_space(space_size, ego_pos, action, sd_lc_dist, dist_to_space, space_size_weight, action_codes):
            longitudinal_term = 1 if (
                (action_codes[0] == 'L' and action == 3 and (ego_pos[0] < traci.vehicle.getPosition(testEnv.Target_left_car)[0] - self.SD_LC_with_respect_to_target_space('ego', 3, 'front') and ego_pos[0] > traci.vehicle.getPosition(left_follower)[0] + self.SD_LC_with_respect_to_target_space('ego', 3,'back'))) or
                (action_codes[0] == 'L' and action == 1 and (ego_pos[0] > traci.vehicle.getPosition(testEnv.Target_left_car)[0] + self.SD_LC_with_respect_to_target_space('ego', 1,'back') and ego_pos[0] < traci.vehicle.getPosition(left_leader)[0] - self.SD_LC_with_respect_to_target_space('ego', 1,'front'))) or
                (action_codes[0] == 'R' and action == 4 and (ego_pos[0] < traci.vehicle.getPosition(testEnv.Target_right_car)[0] - self.SD_LC_with_respect_to_target_space('ego', 4,'front') and ego_pos[0] > traci.vehicle.getPosition(right_follower)[0] + self.SD_LC_with_respect_to_target_space('ego', 4,'back'))) or
                (action_codes[0] == 'R' and action == 2 and (ego_pos[0] > traci.vehicle.getPosition(testEnv.Target_right_car)[0] + self.SD_LC_with_respect_to_target_space('ego', 2,'back') and ego_pos[0] < traci.vehicle.getPosition(right_leader)[0] - self.SD_LC_with_respect_to_target_space('ego', 2,'front')))
        ...
        if id in vehs and testEnv.Target_left_car in vehs and testEnv.Target_right_car in vehs:
            ...
            spaces = [
                [get_space_size(testEnv.Target_left_car, left_leader), get_midpoint_distance(testEnv.Target_left_car, left_leader, ego_pos), 'L1',get_target_car_forward_SD_LC_point_distance(testEnv.Target_left_car, ego_pos, self.SD_LC_with_respect_to_target_space('ego', 1,'back'))],
                [get_space_size(testEnv.Target_right_car, right_leader), get_midpoint_distance(testEnv.Target_right_car, right_leader, ego_pos), 'R1',get_target_car_forward_SD_LC_point_distance(testEnv.Target_left_car, ego_pos, self.SD_LC_with_respect_to_target_space('ego', 2,'back'))],
                [get_space_size(testEnv.Target_left_car, left_follower), get_midpoint_distance(testEnv.Target_left_car, left_follower, ego_pos), 'L2',get_target_car_rear_SD_LC_point_distance(testEnv.Target_left_car, ego_pos, self.SD_LC_with_respect_to_target_space('ego', 3,'front'))],
                [get_space_size(testEnv.Target_right_car, right_follower), get_midpoint_distance(testEnv.Target_right_car, right_follower, ego_pos), 'R2',get_target_car_rear_SD_LC_point_distance(testEnv.Target_left_car, ego_pos, self.SD_LC_with_respect_to_target_space('ego', 4,'front'))]
            ]
            spaces.sort()
        ...
        testEnv.toward_space_reward.append(space_reward)
        testEnv.toward_space_reward_long.append(space_reward_long)
        testEnv.toward_space_reward_lat.append(space_reward_lat)
    ...
    def __chosen_space_size_reward(self): #시뮬레이션 시작 처음 근접 좌우 차량 기준 앞뒤 공간으로 차로 변경 시 보상.
        vehs = traci.vehicle.getIDList()
        if testEnv.Target_left_car in vehs and testEnv.Target_right_car in vehs and 'ego' in vehs:
            if traci.vehicle.getLeader(testEnv.Target_left_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==2:
                left_leader = traci.vehicle.getLeader('ego')[0]
            elif traci.vehicle.getLeader(testEnv.Target_left_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==1:
                left_leader = 'car.left'+str(int(testEnv.Target_left_car[-1])+1)
            ...
            if traci.vehicle.getLaneIndex('ego') == 2:
                if traci.vehicle.getPosition('ego')[0] > traci.vehicle.getPosition(testEnv.Target_left_car)[0]:
                    ego_chosen_space = 'L1'
                else:
                    ego_chosen_space = 'L2'
            if traci.vehicle.getLaneIndex('ego') == 0:
                if traci.vehicle.getPosition('ego')[0] > traci.vehicle.getPosition(testEnv.Target_right_car)[0]:
                    ego_chosen_space = 'R1'
                else:
                    ego_chosen_space = 'R2'
    ...
    def SD_LC_with_respect_to_target_space(self,id,action,direction): #action 1~4 = target space 1~4, action 에 따라 SD_LC를 return /// direction은 해당 action의 SD 중 앞에 것, 뒤에 것중 하나를 지정.
        ...
        if testEnv.Target_left_car in vehs and testEnv.Target_right_car in vehs and 'ego' in vehs:  
            if action == 1 and direction == 'back':
                relative_velocity_term = max([traci.vehicle.getSpeed(testEnv.Target_left_car)-traci.vehicle.getSpeed(id),0] )*time_gap_LC_1
                minimum_clearance_trem = max([traci.vehicle.getSpeed(testEnv.Target_left_car)*time_gap_LC_2,c_LC])
                SD_LC_back = relative_velocity_term + minimum_clearance_trem
                # print('space1 SD_LC: ',SD_LC)
                # space1_size = (traci.vehicle.getPosition(traci.vehicle.getLeader(testEnv.Target_left_car)[0])[0] -traci.vehicle.getPosition(testEnv.Target_left_car)[0])
                ...
                relative_velocity_term = max([traci.vehicle.getSpeed(testEnv.Target_right_car)-traci.vehicle.getSpeed(id),0] )*time_gap_LC_1
                minimum_clearance_trem = max([traci.vehicle.getSpeed(testEnv.Target_right_car)*time_gap_LC_2,c_LC])
                SD_LC_back = relative_velocity_term + minimum_clearance_trem
                # print('space2 SD_LC: ',SD_LC)
                # space2_size = (traci.vehicle.getPosition(traci.vehicle.getLeader(testEnv.Target_right_car)[0])[0] -traci.vehicle.getPosition(testEnv.Target_right_car)[0])
                ...
                relative_velocity_term = max( [traci.vehicle.getSpeed(id) - traci.vehicle.getSpeed(testEnv.Target_left_car) ,0] )*time_gap_LC_1
                minimum_clearance_trem = max([traci.vehicle.getSpeed(id)*time_gap_LC_2,c_LC])
                SD_LC_front = relative_velocity_term +minimum_clearance_trem
                # print('space3 SD_LC: ',SD_LC)
                # space3_size = (traci.vehicle.getPosition(testEnv.Target_left_car)[0]-traci.vehicle.getPosition(traci.vehicle.getFollower(testEnv.Target_left_car)[0])[0])
                ...
                relative_velocity_term = max( [traci.vehicle.getSpeed(id) - traci.vehicle.getSpeed(testEnv.Target_right_car) ,0] )*time_gap_LC_1
                minimum_clearance_trem = max([traci.vehicle.getSpeed(id)*time_gap_LC_2,c_LC])
                SD_LC_front = relative_velocity_term +minimum_clearance_trem
                # print('space4 SD_LC: ',SD_LC)
                # space4_size = (traci.vehicle.getPosition(testEnv.Target_right_car)[0]-traci.vehicle.getPosition(traci.vehicle.getFollower(testEnv.Target_right_car)[0])[0])
    ...
    def __SD_check(self,action):
        if (action == 1 or action == 3) and testEnv.Left_action == True:
            action = 5
        if (action == 2 or action == 4) and testEnv.Right_action == True:
            action = 6
        id = 'ego'
        time_gap_LC_1 =1
        time_gap_LC_2 =0.5 
    ...
    def __reward(self, step_num, action):
        ...
        with self.summary_writer.as_default():
            ...
            tf.summary.scalar('state/left_sd', float(testEnv.Left_SD), step=step)
            tf.summary.scalar('state/right_sd', float(testEnv.Right_SD), step=step)
            tf.summary.scalar('state/front_sd', float(testEnv.Front_SD), step=step)
        ...
        if len(traci.simulation.getCollidingVehiclesIDList()) != 0:
            ...
            self.done = True
        # if testEnv.None_collision == False:
        ...
        if('ego' in vehs and 'accel.rear' in vehs and 'car.forward' in vehs):
            if rear_collision_risk < 0.1:  # 충돌 위험이 매우 낮은 경우
                if (action == 5) and testEnv.Front_SD:
        ...
        if('ego' in vehs and 'accel.rear' in vehs):
            if (self.done and len(traci.simulation.getCollidingVehiclesIDList()) == 0):
                ...
                if chosen_space_info[1] == '1':
                    testEnv.space1_count += 1
                elif chosen_space_info[1] == '2':
                    testEnv.space2_count += 1
                elif chosen_space_info[1] == '3':
                    testEnv.space3_count += 1
                else:
                    testEnv.space4_count += 1
        ...
        if('ego' in vehs and 'accel.rear' in vehs):
            if len(testEnv.last_action) > 0 and rear_collision_risk > 0:
                if (((action == 1 or action == 3) and testEnv.Left_SD == True) or 
                    ((action == 2 or action == 4) and testEnv.Right_SD == True)):
                    if testEnv.Left_action == True and (action == 1 or action == 3):
                        if Lane == 1 and LLP > 0:
                    ...
                    elif testEnv.Right_action == False and (action == 2 or action == 4):
                        if Lane == 1 and LLP < 0:
                            target_lane_lateral_approaching_reward = -LLP * w7 * (1 + rear_collision_risk)
                        elif Lane == 0 and LLP > 0:
                            target_lane_lateral_approaching_reward = (3.2 - LLP) * w7 * (1 + rear_collision_risk)
        ...
        if('ego' in vehs and 'accel.rear' in vehs):
            if (traci.vehicle.getPosition('ego')[0] > traci.vehicle.getPosition('accel.rear')[0]) and testEnv.None_collision == True:
        ...
        # if ('ego' in vehs and 'accel.rear' in vehs and 'car.forward' in vehs):
        #     if(testEnv.Left_SD == False and testEnv.Right_SD == False ):
        ...
        # if len(testEnv.last_action) > 0:
        #     if ((Lane == 1 or Lane == 2) and action == 1 and testEnv.Left_action == True and testEnv.last_action[-1][1] == 1) or \
        #     ((Lane == 1 or Lane == 2) and action == 3 and testEnv.Left_action == True and testEnv.last_action[-1][1] == 3) or \
        #     ((Lane == 1 or Lane == 0) and action == 2 and testEnv.Right_action == True and testEnv.last_action[-1][1] == 2) or \
        #     ((Lane == 1 or Lane == 0) and action == 4 and testEnv.Right_action == True and testEnv.last_action[-1][1] == 4):
    ...
    #     if('ego' in vehs and 'accel.rear' in vehs):
    #         if traci.vehicle.getLaneIndex('ego') == 1:
    #             if(testEnv.ego_LC_success == False and rear_TTC <= 13.2 and rear_clearance >= 0 and traci.vehicle.getLaneIndex('ego') == 1):
    ...
    #     safe_lk_reward = 0
    #     if('ego' in vehs and 'accel.rear' in vehs):
    #         if(rear_TTC > 13.2 and (action == 5) and testEnv.Front_SD):
    ...
    #     if('ego' in vehs and 'accel.rear' in vehs):
    #         if len(testEnv.last_action) > 0 and rear_TTC < 13.2 and (((action == 1 or action == 3) and testEnv.Left_SD == True) or ((action == 2 or action == 4) and testEnv.Right_SD == True)):
    #             if testEnv.Left_action == True and (action == 1 or action == 3):
    #                 if Lane == 1 and LLP > 0:
    ...
    #     if('ego' in vehs and 'accel.rear' in vehs):
    #         if testEnv.None_collision == True:
    ...
    #     self.__SD_check(action)
    #     self.__Front_SD_check()
    #     # print('testEnv.Left_SD: ',testEnv.Left_SD )
    #     # print('testEnv.Right_SD: ',testEnv.Right_SD)
    #     # print('testEnv.Front_SD: ',testEnv.Front_SD)
    ...
    #             #     reward +=1*w4
    #             if(testEnv.ego_LC_success ==False and rear_TTC<=13.2 and rear_clearance >=0 and traci.vehicle.getLaneIndex('ego')==1): #후방 차량 충돌 판단 가능 범위
    ...
    #         if(rear_TTC>13.2 and (action == 5) and testEnv.Front_SD): #safe state LK positive reward                    
    ...
    #         if testEnv.None_collision == True: # if rear_clearance >=-30 episode ends
    #             reward += 30*w8
    #             Reward.append(30*w8)
    #         else:
    #             reward += 0
    ...
    #         Reward.append(0)
    #         reward +=0
    #     # print('testEnv.last_action: ',testEnv.last_action[-1][1])
    #     # print('testEnv.Left_action: ',testEnv.Left_action)
    #     # print('testEnv.Right_action: ',testEnv.Right_action)
    #     if ((Lane == 1 or Lane == 2) and action == 1 and testEnv.Left_action == True and testEnv.last_action[-1][1] == 1) or ((Lane == 1 or Lane == 2) and action == 3 and testEnv.Left_action == True and testEnv.last_action[-1][1] == 3) or ((Lane == 1 or Lane == 0) and action == 2 and testEnv.Right_action == True and testEnv.last_action[-1][1] == 2) or ((Lane == 1 or Lane == 0) and action == 4 and testEnv.Right_action == True and testEnv.last_action[-1][1] == 4):
    ...
    #                     is_safe_LC = (action in [1, 3] and testEnv.Left_SD) or (action in [2, 4] and testEnv.Right_SD)
    ...
    #             if testEnv.ego_LC_success == False and collision_imminent and rear_clearance >= 0:
    #                 # 위험도에 따라 패널티 조정
    ...
    #         # 안전한 상황에서 LK에 대한 보상
    #         if not collision_imminent and (action == 5) and testEnv.Front_SD:
    ...
    #         # 차선 변경 진행에 대한 보상
    #         if len(testEnv.last_action) > 0 and collision_imminent and (
    #             ((action == 1 or action == 3) and testEnv.Left_SD) or 
    #             ((action == 2 or action == 4) and testEnv.Right_SD)
    #         ):                    
    #             if testEnv.Left_action and (action in [1, 3]):
    #                 if Lane == 1 and LLP > 0:
    #                     reward += LLP * w7
    #                     Reward.append(LLP * w7)
    #                 elif Lane == 2 and LLP < 0:
    ...
    #                     reward += 0
    #                     Reward.append(0)
    #             elif not testEnv.Right_action and (action in [2, 4]):
    #                 if Lane == 1 and LLP < 0:
    #                     reward += -LLP * w7
    #                     Reward.append(-LLP * w7)
    #                 elif Lane == 0 and LLP > 0:
    ...
    #     if ((Lane == 1 or Lane == 2) and action == 1 and testEnv.Left_action and testEnv.last_action[-1][1] == 1) or \
    #     ((Lane == 1 or Lane == 2) and action == 3 and testEnv.Left_action and testEnv.last_action[-1][1] == 3) or \
    #     ((Lane == 1 or Lane == 0) and action == 2 and testEnv.Right_action and testEnv.last_action[-1][1] == 2) or \
    #     ((Lane == 1 or Lane == 0) and action == 4 and testEnv.Right_action and testEnv.last_action[-1][1] == 4):
    ...
    def LC_Left(self,action,v_target,c_target):
        ...
        if('ego' in vehs):  
            ...
            if action == 5:
                ...
                if(len(testEnv.ego)!=0):
                    last_ego_x = testEnv.ego[-1][2]
                    last_ego_y = testEnv.ego[-1][3]
                    last_ego_v_y = testEnv.ego[-1][5]
                else:
                ...
                testEnv.last_target_space = xy
                testEnv.last_vehicles = ids
                target_x, target_y = xy[0],xy[1]
                rear_v_id,forward_v_id = ids
                if ego_x-testEnv.initial_x>=testEnv.final_x:
                    path_done = True
                else:
                    path_done = False
                ...
                if path_done == True and traci.vehicle.getLaneIndex('ego') ==1 and LLP <= 0 and LLP >= -0.4 and traci.vehicle.getAngle('ego')>=89.9:
                    print("---------------------------------------LC_succeed")
                    testEnv.initial_x = ego_x
                    testEnv.initial_y = ego_y
                    target_y = -1.6
                    testEnv.theta_i = (90-traci.vehicle.getAngle('ego'))*np.pi/180
                ...
                if testEnv.Left_action == False:
                    # print('testEnv.Left_action == False')
                    t = 0
                    testEnv.t_LC_start = traci.simulation.getTime()
                    x0=0
                    y0=0
                    testEnv.initial_x = ego_x
                    testEnv.initial_y = ego_y
                    testEnv.initial_target_y = target_y
                    testEnv.theta_i = (90-traci.vehicle.getAngle('ego'))*np.pi/180
                    testEnv.coefficient,testEnv.final_x,testEnv.final_y =self.LC_cubic_polynomial_path(testEnv.initial_x,testEnv.initial_y,target_x,target_y,rear_v_id,forward_v_id,testEnv.theta_i,action)
                else:
                    # print('testEnv.Left_action == True')
                    t= traci.simulation.getTime()-testEnv.t_LC_start
                    x0= testEnv.initial_x
                    y0= testEnv.initial_y
                    if path_done:                       
                        testEnv.coefficient = [target_y-ego_y,0,0,0]
                    if LC_succeed:                     
                        testEnv.coefficient,testEnv.final_x,testEnv.final_y =self.LC_cubic_polynomial_path(testEnv.initial_x,testEnv.initial_y,target_x,target_y,rear_v_id,forward_v_id,testEnv.theta_i,action)
                    
                x_local = ego_x - testEnv.initial_x
                # delta = self.stanley(testEnv.coefficient,traci.vehicle.getAngle('ego'),x_local,ego_v)
                x = ego_x -testEnv.initial_x
                y = testEnv.coefficient[2]*x**2+testEnv.coefficient[3]*x**3
                y_prime = 2*testEnv.coefficient[2]*x+3*testEnv.coefficient[3]*x**2
                y_pprime = 2*testEnv.coefficient[2]+6*testEnv.coefficient[3]*x
                ...
                testEnv.ego_control.append(control)
                theta = np.arctan2(ego_y-last_ego_y,ego_x-last_ego_x)
                theta +=delta
        ...
        if testEnv.final_x < ego_x-testEnv.initial_x:
            testEnv.Left_action = False
        else:
            testEnv.Left_action = True
        # print('testEnv.final_x(goal distance): ',testEnv.final_x)
        # print('ego_x-testEnv.initial_x(driven distance): ',ego_x-testEnv.initial_x)
    ...
    def LC_Right(self, action,v_target,c_target):
        ...
        if('ego' in vehs):  
            ...
            if action == 6:
                ...
                if testEnv.Right_action == False:
                    # print('testEnv.Right_action == False')
                    t = 0
                    testEnv.t_LC_start = traci.simulation.getTime()
                    testEnv.initial_x = ego_x
                    testEnv.initial_y = ego_y
                    ...
                    # print('testEnv.Right_action == True')
                    t= traci.simulation.getTime()-testEnv.t_LC_start                        
                    if path_done:
                        testEnv.coefficient = [target_y-ego_y,0,0,0]
                    if LC_succeed:                                                     
    ...
    def reset_left_right_target_vehicle(self):
        if traci.simulation.getTime() >= 0.03 and traci.vehicle.getLaneIndex('ego') == 1: # 기준이되는 옆차로 차량을 시뮬레이션 시작할 때 설정한다. lane 0,2(while LC) no reset
            ...
            right_vehicles.sort() 
            vehs = traci.vehicle.getIDList()
            # if (testEnv.Target_left_car and 'car.left'+str(int(testEnv.Target_left_car[-1])-2) in vehs and 'car.left'+str(int(testEnv.Target_left_car[-1])-1) in vehs and 'car.left'+str(int(testEnv.Target_left_car[-1])+1) in vehs and 'car.left'+str(int(testEnv.Target_left_car[-1])+2) in vehs):
            if (testEnv.Target_left_car and 'car.left0' in vehs and 'car.left1' in vehs and 'car.left2' in vehs and 'car.left3' in vehs and 'car.left4' in vehs and 'car.left5' in vehs and 'car.left6' in vehs and 'car.left7' in vehs):
                if testEnv.Target_left_car != left_vehicles[0][1]:    
                    if int(testEnv.Target_left_car[-1]) < int(left_vehicles[0][1][-1]):
                        self.remove_last_SD_visualization(traci.vehicle.getFollower(testEnv.Target_left_car)[0],testEnv.Target_left_car)
                    else:
                        self.remove_last_SD_visualization(testEnv.Target_left_car,traci.vehicle.getLeader(testEnv.Target_left_car)[0])

            testEnv.Target_left_car = left_vehicles[0][1]

            # if (testEnv.Target_right_car and 'car.right'+str(int(testEnv.Target_right_car[-1])-2) in vehs and 'car.right'+str(int(testEnv.Target_right_car[-1])-1) in vehs and 'car.right'+str(int(testEnv.Target_right_car[-1])+1) in vehs and 'car.right'+str(int(testEnv.Target_right_car[-1])+2) in vehs):
            if (testEnv.Target_right_car and 'car.right0' in vehs and 'car.right1' in vehs and 'car.right2' in vehs and 'car.right3' in vehs and 'car.right4' in vehs and 'car.right5' in vehs and 'car.right6' in vehs and 'car.right7' in vehs):
                if testEnv.Target_right_car != right_vehicles[0][1]:
                    if int(testEnv.Target_right_car[-1]) < int(right_vehicles[0][1][-1]):
                        self.remove_last_SD_visualization(traci.vehicle.getFollower(testEnv.Target_right_car)[0],testEnv.Target_right_car)
                    else:
                        self.remove_last_SD_visualization(testEnv.Target_right_car,traci.vehicle.getLeader(testEnv.Target_right_car)[0])
            
            testEnv.Target_right_car = right_vehicles[0][1]

            # print('New Target_left_car: ',testEnv.Target_left_car)
            # print('New Target_right_car: ',testEnv.Target_right_car)
            traci.vehicle.unsubscribeContext('ego', tc.CMD_GET_VEHICLE_VARIABLE, 120.0)
        if traci.simulation.getTime() >= 0.03 and (testEnv.Target_left_car == '' or testEnv.Target_left_car == None):
            left_vehicles = []
            traci.vehicle.subscribeContext('ego', tc.CMD_GET_VEHICLE_VARIABLE, 120.0, [tc.VAR_POSITION]) 
            for v_id in traci.vehicle.getContextSubscriptionResults('ego'):
                if(traci.vehicle.getLaneIndex(v_id)==2) and not (v_id=='ego'):
            ...
            traci.vehicle.unsubscribeContext('ego', tc.CMD_GET_VEHICLE_VARIABLE, 120.0)
        if traci.simulation.getTime() >= 0.03 and (testEnv.Target_right_car == '' or testEnv.Target_right_car == None):
            right_vehicles = []
            traci.vehicle.subscribeContext('ego', tc.CMD_GET_VEHICLE_VARIABLE, 120.0, [tc.VAR_POSITION]) 
            for v_id in traci.vehicle.getContextSubscriptionResults('ego'):
                if(traci.vehicle.getLaneIndex(v_id)==0) and not (v_id=='ego'):
    ...
    def RuleBasedResult(self):
        ...
        # s1_back = (self.vehicle_position(testEnv.Target_left_car)[0] + self.SD_LC_with_respect_to_target_space('ego',1,'back')) #자차와 왼쪽 차로 옆차량 SD_LC 위치
        # s2_back = (self.vehicle_position(testEnv.Target_right_car)[0] + self.SD_LC_with_respect_to_target_space('ego',2,'back'))   
        # s3_front = (self.vehicle_position(testEnv.Target_left_car)[0] - self.SD_LC_with_respect_to_target_space('ego',3,'front'))           
        # s4_front = (self.vehicle_position(testEnv.Target_right_car)[0] - self.SD_LC_with_respect_to_target_space('ego',4,'front')) 
        ...
        if testEnv.Target_left_car in vehs and testEnv.Target_right_car in vehs and 'ego' in vehs:
            ...
            space1 = (self.vehicle_position(testEnv.Target_left_car)[0] + self.vehicle_position(left_leader)[0])/2
            space2 = (self.vehicle_position(testEnv.Target_right_car)[0] + self.vehicle_position(right_leader)[0])/2
            space3 = (self.vehicle_position(testEnv.Target_left_car)[0] + self.vehicle_position(left_follower)[0])/2
            space4 = (self.vehicle_position(testEnv.Target_right_car)[0] + self.vehicle_position(right_follower)[0])/2
            ...
            s1_back= testEnv.S[1]
            s1_front = testEnv.S[5]
            s2_back= testEnv.S[2]
            s2_front= testEnv.S[6]
            s3_front= testEnv.S[3]
            s3_back= testEnv.S[7]
            s4_front= testEnv.S[4]
            s4_back= testEnv.S[8]
            space1 = testEnv.last_Space1
            space2 = testEnv.last_Space2
            space3 = testEnv.last_Space3
            space4 = testEnv.last_Space4
            Safe_space1 = testEnv.last_Safe_Space1
            Safe_space2 = testEnv.last_Safe_Space2
            Safe_space3 = testEnv.last_Safe_Space3
            Safe_space4 = testEnv.last_Safe_Space4
            left_leader, left_follower, right_leader, right_follower = self.reset_left_right_target_vehicle()
        ...
        ego_chosen_space = None
        if ego_x< self.vehicle_position(left_leader)[0] and ego_x>self.vehicle_position(testEnv.Target_left_car)[0] and traci.vehicle.getLaneIndex('ego') == 2:
            ego_chosen_space =1
        if ego_x< self.vehicle_position(right_leader)[0] and ego_x>self.vehicle_position(testEnv.Target_right_car)[0] and traci.vehicle.getLaneIndex('ego') == 0:
            ego_chosen_space =2
        if ego_x< self.vehicle_position(testEnv.Target_left_car)[0] and ego_x>self.vehicle_position(left_follower)[0] and traci.vehicle.getLaneIndex('ego') == 2:
            ego_chosen_space =3
        if ego_x< self.vehicle_position(testEnv.Target_right_car)[0] and ego_x>self.vehicle_position(right_follower)[0] and traci.vehicle.getLaneIndex('ego') == 0:
            ego_chosen_space =4
        #t1
        if ego_x > s1_front:
            testEnv.ego_at_Target[0] =False
            # print('s1_1st')
            ...
            testEnv.ego_at_Target[0] =True            
            # print('s1_2nd')
            v_t = (traci.vehicle.getSpeed(left_leader) +traci.vehicle.getSpeed(testEnv.Target_left_car))/2
            mid = (self.vehicle_position(left_leader)[0] +self.vehicle_position(testEnv.Target_left_car)[0])/2
            # if ego_x>mid:
            ...
            testEnv.ego_at_Target[0] =False
            # print('s1_3rd')
            v_t = traci.vehicle.getSpeed(testEnv.Target_left_car)
        ...
        if ego_x > s2_front:
            ...
            testEnv.ego_at_Target[1] =True
            # print('s2_2nd')
            v_t = (traci.vehicle.getSpeed(right_leader) +traci.vehicle.getSpeed(testEnv.Target_right_car))/2
            mid = (self.vehicle_position(right_leader)[0] +self.vehicle_position(testEnv.Target_right_car)[0])/2
            # if ego_x>mid:
            #     print('s2_2nd_1')
            #     s = ego_x - mid
            #     t2 = (-v_ego-math.sqrt(v_ego**2+2*ego_decel*s))/ego_decel
            ...
            testEnv.ego_at_Target[1] =False
            # print('s2_3rd')
            v_t = traci.vehicle.getSpeed(testEnv.Target_right_car)
            s = s2_back-ego_x
            # t2 = (-v_ego+math.sqrt(v_ego**2+2*ego_accel*s))/ego_accel
            v0 = np.abs(v_ego - v_t)
        ...
        if ego_x > s3_front:
            ...
            testEnv.ego_at_Target[2] =True
            # print('s3_2nd')
            v_t = (traci.vehicle.getSpeed(left_leader)+traci.vehicle.getSpeed(testEnv.Target_left_car))/2
            mid = (self.vehicle_position(testEnv.Target_left_car)[0] +self.vehicle_position(left_follower)[0])/2
            # if ego_x>mid:
        ...
        if ego_x > s4_front: 
            ...
            testEnv.ego_at_Target[3] =True
            # print('s4_2nd')
            v_t = (traci.vehicle.getSpeed(right_leader)+traci.vehicle.getSpeed(testEnv.Target_right_car))/2
            mid = (self.vehicle_position(testEnv.Target_right_car)[0] +self.vehicle_position(right_follower)[0])/2
            # if ego_x>mid:
        ...
        # if testEnv.last_target_space[0] != [0,0]:
        ...
        #     x_final = 0
        # print('x_final: ',x_final)
        # print('testEnv.coefficient: ',testEnv.coefficient)
        for idx,value in enumerate(testEnv.ego_at_Target):
            if value == 1:
                if testEnv.x_final != 0:
                    T_LC_continue[idx],_ = self.calculate_LC_time(testEnv.coefficient, testEnv.x_final, v_ego)           
        ...
        for idx, time in enumerate(T_avoidance):
            ...
            # else:
            #     result[idx] = False
            if testEnv.mode[idx] == 1 and traci.vehicle.getLaneIndex('ego')!=1:
                result[idx] = True
        Rear_clearance_threshold = 100 
        TTC_R_threshold = 15
        if rear_relative_distance>=Rear_clearance_threshold or TTC_R>TTC_R_threshold or testEnv.rear_collision_mode == 0:
            return 5
    ...
    def confusion_matrix_data_collection(self,episode): #Collect the data of Rule best space and RL action 
        ...
        df_Rule_RL = pd.DataFrame(testEnv.Rule_RL,columns=col_Rule_RL)
    ...
    def step(self, action): #action-> 0: LK_const_vel, 1: LK_accel, 2: LK_decel
        ...
        # testEnv.vehicles_tau[1] =2.27 ##### RL 검증 space 3
        # testEnv.vehicles_tau[4] =2.27 #space1
        # testEnv.vehicles_tau[2] =2.27
        # testEnv.vehicles_tau[3] =2.27 #space 4
        # testEnv.vehicles_tau[11] =2.27 #space 2
        # testEnv.vehicles_tau[12] =2.27 
        # testEnv.vehicles_tau[13] =2.27 
        # testEnv.vehicles_tau[14] =2.27 
        # testEnv.vehicles_tau[15] =2.27 
        # testEnv.vehicles_tau[16] =2.27
        # vehs = traci.vehicle.getIDList()
        traci.simulationStep()
        ...
        if traci.simulation.getTime() > 0.03 and ('car.forward' not in vehs):
            ...
            # sys.stdout.flush()
        # print('testEnv.Target_right_car: ',testEnv.Target_right_car)
        # print('testEnv.Target_left_car: ',testEnv.Target_left_car)
        ...
        if traci.simulation.getTime() == 0.03: # 기준이되는 옆차로 차량을 시뮬레이션 시작할 때 설정한다.(-> 후방 차량의 추돌 위험이 감지 될 때 마다 기준이 되는 옆차로 차량의 위치를 갱신하는게 맞다.)
            ...
            testEnv.Target_left_car = left_vehicles[0][1]
            testEnv.Target_right_car = right_vehicles[0][1]
            print('Initial Target_left_car: ',testEnv.Target_left_car)
            print('Initial Target_right_car: ',testEnv.Target_right_car)
            traci.vehicle.unsubscribeContext('ego', tc.CMD_GET_VEHICLE_VARIABLE, 120.0)
        ...
        if('ego' in vehs and 'car.forward' in vehs and 'accel.rear' in vehs): 
            ...
            if self.gui_on:
                ...
                self.SD_visualization(testEnv.Target_left_car,self.SD_LC_with_respect_to_target_space('ego',1,'back'),'front','LC')
                self.SD_visualization(left_leader,self.SD_LC_with_respect_to_target_space('ego',1,'front'),'back','LC')
                self.SD_visualization(testEnv.Target_right_car,self.SD_LC_with_respect_to_target_space('ego',2,'back'),'front','LC')
                ...
                self.SD_visualization(testEnv.Target_left_car,self.SD_LC_with_respect_to_target_space('ego',3,'front'),'back','LC')
                self.SD_visualization(right_follower,self.SD_LC_with_respect_to_target_space('ego',4,'back'),'front','LC')
                self.SD_visualization(testEnv.Target_right_car,self.SD_LC_with_respect_to_target_space('ego',4,'front'),'back','LC')
            ...
            if action == 0: # LK mode delay collision (collision mitigation)
                ...
                self.other_mode_reset(action)
                if testEnv.last_action[-1][1] != 1:
                    testEnv.Left_action = False 


                if ego_x >= s1_back+epsilon and ego_x <= s1_front-epsilon: # LC 모드 진입 조건
                    testEnv.mode[1] = 2 #LC mode

                elif (ego_x< s1_back+epsilon or ego_x>s1_front-epsilon) and testEnv.mode[1] !=2:
                    testEnv.mode[1] = 1
                
                if ego_x < s1_back or ego_x > s1_front: # LC 모드 탈출,(preLC 모드 재진입조건)
                    # print(':::::::::::::::::::::::preLC 조건')
                    testEnv.mode[1] = 1 #preLC mode
                ...
                if testEnv.mode[1] == 1:                   
                    if ego_x > s1_front -epsilon:
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s1_front - epsilon:                        
                            ...
                            # v_t = max(min(traci.vehicle.getSpeed(left_leader),traci.vehicle.getSpeed(Forward_id)),traci.vehicle.getSpeed(testEnv.Target_left_car))
                            v_t = traci.vehicle.getSpeed(left_leader)
                            c_t = s1_front - epsilon
                            if self.gui_on:
                                self.Target_point_visualization(left_leader,[s1_front - epsilon,self.vehicle_position(left_leader)[1]])
                        testEnv.Target1.append([traci.simulation.getTime(),1,s1_front,space1,v_t]) 
                        # print([0,1,0,0,0,0])
                        ...
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s1_back+epsilon:
                            ...
                            c_t = s1_back+epsilon
                            if self.gui_on:
                                self.Target_point_visualization(testEnv.Target_left_car,[s1_back+epsilon,self.vehicle_position(testEnv.Target_left_car)[1]])
                        testEnv.Target1.append([traci.simulation.getTime(),1,s1_back,space1,v_t]) 
                        # print([0,1,0,0,0,0])
                ...
                if testEnv.mode[1] == 2:
                    ...
                    if (traci.vehicle.getLaneIndex('ego') == 1):
                        if(self.vehicle_position('car.forward')[0]-ego_x<SD_LK_forward):
                            ...
                            v_t = (b*traci.vehicle.getSpeed(testEnv.Target_left_car)+a*traci.vehicle.getSpeed('car.forward'))/(a+b)
                            c_t = s1_back+epsilon+a/(a+b)*(self.vehicle_position('car.forward')[0]-SD_LK_forward -(s1_back+epsilon))- ego_x
                            if self.gui_on:
                                self.Target_point_visualization('weighted_point_with_Forward',[s1_back+epsilon+a/(a+b)*(self.vehicle_position('car.forward')[0]-SD_LK_forward -(s1_back+epsilon)),self.vehicle_position(testEnv.Target_left_car)[1]])
                        else:
                            a = ego_x - (s1_back+epsilon)
                            b = s1_front-epsilon - ego_x
                            v_t = (b*traci.vehicle.getSpeed(testEnv.Target_left_car)+a*traci.vehicle.getSpeed(left_leader))/(a+b)
                ...
                self.other_mode_reset(action)
                if testEnv.last_action[-1][1] != 2:
                    testEnv.Right_action = False 
                if ego_x >= s2_back+epsilon and ego_x<= s2_front-epsilon: #LC 모드 진입 조건
                    testEnv.mode[2] =2 #LC mode
                elif (ego_x< s2_back+epsilon or ego_x>s2_front-epsilon) and testEnv.mode[2] !=2:
                    testEnv.mode[2] = 1
                if ego_x < s2_back or ego_x > s2_front: #LC 모드 탈출,(preLC 모드 재진입조건)
                    # print(':::::::::::::::::::::::preLC 조건')
                    testEnv.mode[2] = 1 #preLC mode
                ...
                if testEnv.mode[2] == 1:  
                    if ego_x > s2_front -epsilon:
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s2_front - epsilon:
                            ...
                            # v_t = max(min(traci.vehicle.getSpeed(right_leader),traci.vehicle.getSpeed(Forward_id)),traci.vehicle.getSpeed(testEnv.Target_right_car))
                            v_t = traci.vehicle.getSpeed(right_leader)
                            c_t = s2_front - epsilon
                            if self.gui_on:
                                self.Target_point_visualization(right_leader,[s2_front - epsilon,self.vehicle_position(right_leader)[1]])
                        testEnv.Target2.append([traci.simulation.getTime(),2,s2_front,space2,v_t]) 
                        # print([0,0,1,0,0,0]) 
                        ...
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s2_back+epsilon:
                            ...
                            c_t = s2_back+epsilon
                            if self.gui_on:
                                self.Target_point_visualization(testEnv.Target_right_car,[s2_back+epsilon,self.vehicle_position(testEnv.Target_right_car)[1]])
                        testEnv.Target2.append([traci.simulation.getTime(),2,s2_back,space2,v_t]) 
                        # print([0,0,1,0,0,0])
                ...
                if testEnv.mode[2] == 2:
                    ...
                    if (traci.vehicle.getLaneIndex('ego') == 1):
                        if(self.vehicle_position('car.forward')[0]-ego_x<SD_LK_forward):
                            ...
                            b = ego_x - (self.vehicle_position('car.forward')[0]-SD_LK_forward)
                            v_t = (b*traci.vehicle.getSpeed(testEnv.Target_right_car)+a*traci.vehicle.getSpeed('car.forward'))/(a+b)
                            c_t = s2_back+epsilon+a/(a+b)*(self.vehicle_position('car.forward')[0]-SD_LK_forward -(s2_back+epsilon))- ego_x
                            if self.gui_on:
                                self.Target_point_visualization('weighted_point_with_Forward',[s2_back+epsilon+a/(a+b)*(self.vehicle_position('car.forward')[0]-SD_LK_forward -(s2_back+epsilon)),self.vehicle_position(testEnv.Target_right_car)[1]])
                        else:
                            a = ego_x - (s2_back+epsilon)
                            b = s2_front-epsilon - ego_x
                            v_t = (b*traci.vehicle.getSpeed(testEnv.Target_right_car)+a*traci.vehicle.getSpeed(right_leader))/(a+b)
                ...
                self.other_mode_reset(action)   
                if testEnv.last_action[-1][1] != 3:
                    testEnv.Left_action = False
                if ego_x >= s3_back+epsilon and ego_x <= s3_front-epsilon: # LC 모드 진입 조건
                    testEnv.mode[3] = 2 #LC mode
                elif (ego_x< s3_back+epsilon or ego_x>s3_front-epsilon) and testEnv.mode[3] !=2:
                    testEnv.mode[3] = 1
                if ego_x < s3_back or ego_x > s3_front: # LC 모드 탈출,(preLC 모드 재진입조건)
                    # print(':::::::::::::::::::::::preLC 조건')
                    testEnv.mode[3] = 1 #preLC mode
                ...
                if testEnv.mode[3] == 1:                   
                    if ego_x > s3_front -epsilon:
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s3_front - epsilon:
                            ...
                            if self.gui_on:
                                self.Target_point_visualization(left_leader,[s3_front - epsilon,self.vehicle_position(testEnv.Target_left_car)[1]])
                        testEnv.Target3.append([traci.simulation.getTime(),3,s3_front,space3,v_t]) 
                        # print([0,0,0,1,0,0])
                        ...
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s3_back+epsilon:
                            ...
                            v_t = max(min(traci.vehicle.getSpeed(testEnv.Target_left_car),traci.vehicle.getSpeed(Forward_id)),traci.vehicle.getSpeed(left_follower))
                            c_t = s3_back+epsilon
                            if self.gui_on:
                                self.Target_point_visualization(left_follower,[s3_back+epsilon,self.vehicle_position(left_follower)[1]])
                        testEnv.Target3.append([traci.simulation.getTime(),3,s3_back,space3,v_t]) 
                        # print([0,0,0,1,0,0])
                ...
                if testEnv.mode[3] == 2:
                    ...
                    if (traci.vehicle.getLaneIndex('ego') == 1):
                        if(self.vehicle_position('car.forward')[0]-ego_x<SD_LK_forward):
                            ...
                            v_t = (b*traci.vehicle.getSpeed(left_follower)+a*traci.vehicle.getSpeed(testEnv.Target_left_car))/(a+b)
                            c_t = s3_front - epsilon - ego_x
                            if self.gui_on:
                                self.Target_point_visualization(testEnv.Target_left_car,[s3_front - epsilon,self.vehicle_position(testEnv.Target_left_car)[1]])
                    else: # laneindex == 2 (TargetLane)
                        a = ego_x - (s3_back+epsilon)
                        b = s3_front-epsilon - ego_x
                        v_t = (b*traci.vehicle.getSpeed(left_follower)+a*traci.vehicle.getSpeed(testEnv.Target_left_car))/(a+b)
                ...
                if testEnv.last_action[-1][1] != 4:
                    testEnv.Right_action = False 
                if ego_x >= s4_back+epsilon and ego_x <= s4_front-epsilon: # LC 모드 진입 조건
                    testEnv.mode[4] = 2 #LC mode
                elif (ego_x< s4_back+epsilon or ego_x>s4_front-epsilon) and testEnv.mode[4] !=2:
                    testEnv.mode[4] = 1
                if ego_x < s4_back or ego_x > s4_front: # LC 모드 탈출,(preLC 모드 재진입조건)
                    # print(':::::::::::::::::::::::preLC 조건')
                    testEnv.mode[4] = 1 #preLC mode
                ...
                if testEnv.mode[4] == 1:                   
                    if ego_x > s4_front -epsilon:
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s4_front - epsilon:
                            ...
                            # v_t = max(min(traci.vehicle.getSpeed(testEnv.Target_right_car),traci.vehicle.getSpeed(Forward_id)),traci.vehicle.getSpeed(right_follower))
                            v_t = traci.vehicle.getSpeed(testEnv.Target_right_car)
                            c_t = s4_front - epsilon
                            if self.gui_on:
                                self.Target_point_visualization(testEnv.Target_right_car,[s4_front - epsilon,self.vehicle_position(testEnv.Target_right_car)[1]])
                        testEnv.Target4.append([traci.simulation.getTime(),4,s4_front,space4,v_t]) 
                        # print([0,0,0,0,1,0])
                        ...
                        testEnv.Target4.append([traci.simulation.getTime(),4,s4_back,space4,v_t]) 
                        # print([0,0,0,0,1,0])
                ...
                if testEnv.mode[4] == 2:
                    ...
                    if (traci.vehicle.getLaneIndex('ego') == 1):
                        if(self.vehicle_position('car.forward')[0]-ego_x<SD_LK_forward):
                            ...
                            v_t = (b*traci.vehicle.getSpeed(right_follower)+a*traci.vehicle.getSpeed(testEnv.Target_right_car))/(a+b)
            ...
            testEnv.last_Space1=space1
            testEnv.last_Space2=space2
            testEnv.last_Space3=space3
            testEnv.last_Space4=space4
            testEnv.S = [0,s1_back,s2_back,s3_front,s4_front,s1_front,s2_front,s3_back,s4_back]
        ...
        testEnv.Rule_RL.append([traci.simulation.getTime(),self.RuleBasedResult(),action])  
        ...
        for veh_id in vehs:
            ...
            if traci.vehicle.getRoadID(veh_id) == 'E5': 
                ...
                ID = veh_id.split('.')
                velocity_y=0
                if veh_id== 'ego' and not (len(testEnv.ego)==0):
                    velocity_y = (y1 - testEnv.ego[-1][3])/self.step_length
                if veh_id== 'car.left0' and not (len(testEnv.left0))==0:
                    velocity_y = (y1 - testEnv.left0[-1][3])/self.step_length
                if veh_id== 'car.left1' and not (len(testEnv.left1))==0:
                    velocity_y = (y1 - testEnv.left1[-1][3])/self.step_length
                if veh_id== 'accel.rear' and not (len(testEnv.rear))==0:
                    velocity_y = (y1 - testEnv.rear[-1][3])/self.step_length
                if veh_id== 'car.right0' and not (len(testEnv.right0))==0:
                    velocity_y = (y1 - testEnv.right0[-1][3])/self.step_length
                if veh_id== 'car.right1' and not (len(testEnv.right1))==0:
                    velocity_y = (y1 - testEnv.right1[-1][3])/self.step_length
                if veh_id== 'car.left2' and not (len(testEnv.left2))==0:
                    velocity_y = (y1 - testEnv.left2[-1][3])/self.step_length
                if veh_id== 'car.left3' and not (len(testEnv.left3))==0:
                    velocity_y = (y1 - testEnv.left3[-1][3])/self.step_length
                if veh_id== 'car.left4' and not (len(testEnv.left4))==0:
                    velocity_y = (y1 - testEnv.left4[-1][3])/self.step_length
                if veh_id== 'car.left5' and not (len(testEnv.left5))==0:
                    velocity_y = (y1 - testEnv.left5[-1][3])/self.step_length
                if veh_id== 'car.left6' and not (len(testEnv.left6))==0:
                    velocity_y = (y1 - testEnv.left6[-1][3])/self.step_length
                if veh_id== 'car.left7' and not (len(testEnv.left7))==0:
                    velocity_y = (y1 - testEnv.left7[-1][3])/self.step_length
                if veh_id== 'car.forward' and not (len(testEnv.forward))==0:
                    velocity_y = (y1 - testEnv.forward[-1][3])/self.step_length
                if veh_id== 'car.right2' and not (len(testEnv.right2))==0:
                    velocity_y = (y1 - testEnv.right2[-1][3])/self.step_length
                if veh_id== 'car.right3' and not (len(testEnv.right3))==0:
                    velocity_y = (y1 - testEnv.right3[-1][3])/self.step_length
                if veh_id== 'car.right4' and not (len(testEnv.right4))==0:
                    velocity_y = (y1 - testEnv.right4[-1][3])/self.step_length
                if veh_id== 'car.right5' and not (len(testEnv.right5))==0:
                    velocity_y = (y1 - testEnv.right5[-1][3])/self.step_length
                if veh_id== 'car.right6' and not (len(testEnv.right6))==0:
                    velocity_y = (y1 - testEnv.right6[-1][3])/self.step_length
                if veh_id== 'car.right7' and not (len(testEnv.right7))==0:
                    velocity_y = (y1 - testEnv.right7[-1][3])/self.step_length
                ...
                acceleration_y=0
                if veh_id== 'ego' and not (len(testEnv.ego)==0):
                    acceleration_y = (velocity_y - testEnv.ego[-1][5])/self.step_length
                if veh_id== 'car.left0' and not (len(testEnv.left0))==0:
                    acceleration_y = (velocity_y- testEnv.left0[-1][5])/self.step_length
                if veh_id== 'car.left1' and not (len(testEnv.left1))==0:
                    acceleration_y = (velocity_y - testEnv.left1[-1][5])/self.step_length
                if veh_id== 'accel.rear' and not (len(testEnv.rear))==0:
                    acceleration_y = (velocity_y - testEnv.rear[-1][5])/self.step_length
                if veh_id== 'car.right0' and not (len(testEnv.right0))==0:
                    acceleration_y = (velocity_y - testEnv.right0[-1][5])/self.step_length
                if veh_id== 'car.right1' and not (len(testEnv.right1))==0:
                    acceleration_y = (velocity_y - testEnv.right1[-1][5])/self.step_length
                if veh_id== 'car.left2' and not (len(testEnv.left2))==0:
                    acceleration_y = (velocity_y - testEnv.left2[-1][5])/self.step_length
                if veh_id== 'car.left3' and not (len(testEnv.left3))==0:
                    acceleration_y = (velocity_y - testEnv.left3[-1][5])/self.step_length
                if veh_id== 'car.left4' and not (len(testEnv.left4))==0:
                    acceleration_y = (velocity_y - testEnv.left4[-1][5])/self.step_length
                if veh_id== 'car.left5' and not (len(testEnv.left5))==0:
                    acceleration_y = (velocity_y - testEnv.left5[-1][5])/self.step_length
                if veh_id== 'car.left6' and not (len(testEnv.left6))==0:
                    acceleration_y = (velocity_y - testEnv.left6[-1][5])/self.step_length
                if veh_id== 'car.left7' and not (len(testEnv.left7))==0:
                    acceleration_y = (velocity_y - testEnv.left7[-1][5])/self.step_length
                if veh_id== 'car.forward' and not (len(testEnv.forward))==0:
                    acceleration_y = (velocity_y - testEnv.forward[-1][5])/self.step_length
                if veh_id== 'car.right2' and not (len(testEnv.right2))==0:
                    acceleration_y = (velocity_y - testEnv.right2[-1][5])/self.step_length
                if veh_id== 'car.right3' and not (len(testEnv.right3))==0:
                    acceleration_y = (velocity_y - testEnv.right3[-1][5])/self.step_length
                if veh_id== 'car.right4' and not (len(testEnv.right4))==0:
                    acceleration_y = (velocity_y - testEnv.right4[-1][5])/self.step_length
                if veh_id== 'car.right5' and not (len(testEnv.right5))==0:
                    acceleration_y = (velocity_y - testEnv.right5[-1][5])/self.step_length
                if veh_id== 'car.right6' and not (len(testEnv.right6))==0:
                    acceleration_y = (velocity_y - testEnv.right6[-1][5])/self.step_length
                if veh_id== 'car.right7' and not (len(testEnv.right7))==0:
                    acceleration_y = (velocity_y - testEnv.right7[-1][5])/self.step_length
                ...
                if(veh_id == 'ego'):
                    testEnv.ego.append(vehicle_state)
                    # print(vehicle_state)
                if(veh_id =='car.left0'):
                    testEnv.left0.append(vehicle_state)
                if(veh_id=='car.left1'):
                    testEnv.left1.append(vehicle_state)
                if(veh_id=='accel.rear'):
                    testEnv.rear.append(vehicle_state)
                if(veh_id=='car.right0'):
                    testEnv.right0.append(vehicle_state)
                if(veh_id=='car.right1'):
                    testEnv.right1.append(vehicle_state)
                if(veh_id=='car.left2'):
                    testEnv.left2.append(vehicle_state)
                if(veh_id=='car.left3'):
                    testEnv.left3.append(vehicle_state)
                if(veh_id=='car.left4'):
                    testEnv.left4.append(vehicle_state)
                if(veh_id=='car.left5'):
                    testEnv.left5.append(vehicle_state)
                if(veh_id=='car.left6'):
                    testEnv.left6.append(vehicle_state)
                if(veh_id=='car.left7'):
                    testEnv.left7.append(vehicle_state)
                if(veh_id=='car.forward'):
                    testEnv.forward.append(vehicle_state)
                if(veh_id=='car.right2'):
                    testEnv.right2.append(vehicle_state)
                if(veh_id=='car.right3'):
                    testEnv.right3.append(vehicle_state)
                if(veh_id=='car.right4'):
                    testEnv.right4.append(vehicle_state)    
                if(veh_id=='car.right5'):
                    testEnv.right5.append(vehicle_state)   
                if(veh_id=='car.right6'):
                    testEnv.right6.append(vehicle_state)    
                if(veh_id=='car.right7'):
                    testEnv.right7.append(vehicle_state)   
            ...
            if veh_id == 'ego':
                if self.__ego_vehicle_LC_start() and traci.simulation.getTime()>=0.01:
                    ...
                    testEnv.ego_LC_start =True
                    traci.vehicle.setLaneChangeMode('ego',0)
                self.__ego_vehicle_LC_completed(action) # LC completed checking
                testEnv.lane_buffer_ego = traci.vehicle.getLaneIndex('ego') # ego_car lane buffer  
            ...
            if traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 'a':
                ...
                # if traci.vehicle.getSpeed('accel.rear') <= testEnv.rearMaxSpeed:
            ...
            if (traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 'c'):
                ...
                if veh_id == 'car.left0':
                    tau = testEnv.vehicles_tau[0]                    
                elif veh_id =='car.left1':
                    tau = testEnv.vehicles_tau[1]                    
                elif veh_id =='car.right0':
                    tau = testEnv.vehicles_tau[2]                    
                elif veh_id =='car.right1':
                    tau = testEnv.vehicles_tau[3]                    
                elif veh_id =='car.left2':
                    tau = testEnv.vehicles_tau[4]               
                elif veh_id =='car.left3':
                    tau = testEnv.vehicles_tau[5]                    
                elif veh_id =='car.left4':
                    tau = testEnv.vehicles_tau[6]
                elif veh_id =='car.left5':
                    tau = testEnv.vehicles_tau[7]
                elif veh_id =='car.left6':
                    tau = testEnv.vehicles_tau[8]
                elif veh_id =='car.left7':
                    tau = testEnv.vehicles_tau[9]
                elif veh_id =='car.forward':
                    tau = testEnv.vehicles_tau[10]                    
                elif veh_id =='car.right2':
                    tau = testEnv.vehicles_tau[11]                    
                elif veh_id =='car.right3':
                    tau = testEnv.vehicles_tau[12]                    
                elif veh_id =='car.right4':
                    tau = testEnv.vehicles_tau[13]
                elif veh_id =='car.right5':
                    tau = testEnv.vehicles_tau[14]
                elif veh_id =='car.right6':
                    tau = testEnv.vehicles_tau[15]
                elif veh_id =='car.right7':
                    tau = testEnv.vehicles_tau[16]
                else:
                    tau = 1.36
                ...
                if traci.vehicle.getLeader(veh_id) is not None: # 선행 차량이 있을 때 ACC
                    Leader_id,c_front = traci.vehicle.getLeader(veh_id)
                    v_preceding= traci.vehicle.getSpeed(Leader_id)
                    if Leader_id == 'ego'and testEnv.tau_random[int(veh_id[-1])] <= 0.5: # 50% 확률로 앞으로 끼어드는 ego vehicle 양보 x
                        tau = 0
                        print('tau == 0')
                    c_desire = c0+tau*v_preceding
        ...
        # print(testEnv.step_num)
        ##### update Left Right Target Car #####
        # if 'ego'in vehs and testEnv.Target_left_car in vehs and testEnv.Target_right_car in vehs and traci.simulation.getTime()>0.03:
            
        #     last_target_left =''    
        #     last_target_right =''  
        #     if (traci.vehicle.getPosition('ego')[0]> traci.vehicle.getPosition(traci.vehicle.getLeader(testEnv.Target_left_car)[0])[0]):
        #         last_target_left = testEnv.Target_left_car
        #         testEnv.Target_left_car = traci.vehicle.getLeader(testEnv.Target_left_car)[0]                
        #         print('New Target_left_car: ',testEnv.Target_left_car)                
        #     if (traci.vehicle.getPosition('ego')[0]<traci.vehicle.getPosition(traci.vehicle.getFollower(testEnv.Target_left_car)[0])[0]):
        #         last_target_left = testEnv.Target_left_car
        #         testEnv.Target_left_car = traci.vehicle.getFollower(testEnv.Target_left_car)[0]                
        #         print('New Target_left_car: ',testEnv.Target_left_car)  
                
        #     if(traci.vehicle.getPosition('ego')[0]> traci.vehicle.getPosition(traci.vehicle.getLeader(testEnv.Target_right_car)[0])[0]):
        #         last_target_right = testEnv.Target_right_car
        #         testEnv.Target_right_car = traci.vehicle.getLeader(testEnv.Target_right_car)[0]
        #         print('New Target_right_car: ',testEnv.Target_right_car) 
        #     if(traci.vehicle.getPosition('ego')[0]<traci.vehicle.getPosition(traci.vehicle.getFollower(testEnv.Target_right_car)[0])[0]):
        #         last_target_right = testEnv.Target_right_car
        #         testEnv.Target_right_car = traci.vehicle.getFollower(testEnv.Target_right_car)[0]
        #         print('New Target_right_car: ',testEnv.Target_right_car)
        #     if last_target_left != '':
        #         polygon_ids = traci.polygon.getIDList()
        #         for polygon_id in polygon_ids:  
        ...
        if('ego' in vehs and 'car.forward' in vehs and 'accel.rear' in vehs):
            ...
            reward = self.__reward(testEnv.step_num, action) # rear vehicle collision : -10, collision caused by ego : -20, LC_succeed_with_biggest_space : +20, LC_succeed_with_smaller_space : +10, step*-0.01
        else:
            nextstate = testEnv.last_state ## it might wrong code
            self.done = True 
            reward = self.__reward(testEnv.step_num, action)
            if 'ego' not in vehs:
                print('no ego')
            if 'car.forward' not in vehs:
        ...
        testEnv.last_action.append([traci.simulation.getTime(),action])
