...
def generate_routefile():
    ...
    with open("highway.rou.xml", "w") as routes:
        ...
        <flow id="truck0" departPos="free" begin="20.00" from="E4" to="E6" end="500.00" number="10" type="truck" color="0,0,1"/>
        <flow id="truck1" departPos="free" begin="25.00" from="E7" to="E6" end="500.00" number="10" type="truck" color="0,0,1"/>
        ...
        <flow id="truck2" departPos="free" begin="50.00" from="E4" to="E6" end="500.00" number="10" type="truck" color="0,0,1"/>
        <flow id="truck3" departPos="free" begin="55.00" from="E7" to="E6" end="500.00" number="10" type="truck" color="0,0,1"/>
       """, file=routes)
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        for veh_id in vehs:
            ...
            if traci.vehicle.getRoadID(veh_id) == 'E5': 
                ...
                if ID[0][0] == 'c' and ID[0][-1]=='1'and not (len(car0[int(ID[1])])==0):
                    acceleartion_x = traci.vehicle.getSpeed(veh_id) - car0[int(ID[1])][-1][4]
                if ID[0][0] == 'c' and ID[0][-1]=='0'and not (len(car1[int(ID[1])])==0):
                    acceleartion_x = traci.vehicle.getSpeed(veh_id) - car1[int(ID[1])][-1][4]
                if ID[0][0] == 'c' and ID[0][-1]=='1'and not (len(car1[int(ID[1])])==0):
                    acceleartion_x = traci.vehicle.getSpeed(veh_id) - car1[int(ID[1])][-1][4]
                if ID[0][0] == 'c' and ID[0][-1]=='0'and not (len(car2[int(ID[1])])==0):
                    acceleartion_x = traci.vehicle.getSpeed(veh_id) - car2[int(ID[1])][-1][4]
                if ID[0][0] == 'c' and ID[0][-1]=='1'and not (len(car2[int(ID[1])])==0):
                    acceleartion_x = traci.vehicle.getSpeed(veh_id) - car2[int(ID[1])][-1][4]
                if ID[0][0] == 'c' and ID[0][-1]=='0'and not (len(car3[int(ID[1])])==0):
                    acceleartion_x = traci.vehicle.getSpeed(veh_id) - car3[int(ID[1])][-1][4]
                if ID[0][0] == 'c' and ID[0][-1]=='1'and not (len(car3[int(ID[1])])==0):
                    acceleartion_x = traci.vehicle.getSpeed(veh_id) - car3[int(ID[1])][-1][4]
                ...
                # if traci.simulation.getCurrentTime() % 100 ==0:
                #     if(veh_id == 'accel0.0'):
                #         plt.subplot(4,2,1)
                #         plt.axis([15, 25, 0, 80])
                #         plt.scatter(traci.simulation.getCurrentTime()/1000,accel0[0][-1][4],color = "red", s=1)
                #         plt.grid()
                #         plt.xlabel('time (sec)')
                #         plt.ylabel('velocity (v/s)')
                #         plt.title('First collision collider')
                #         plt.pause(0.000001)
                #         plt.draw()
                ...
                #     if(veh_id == 'accel0.1'):
                #         plt.axis([40, 47, 0, 80])
                #         plt.scatter(traci.simulation.getCurrentTime()/1000,accel0[1][-1][4],color = "red", s=1)
                #         plt.grid()
                #         plt.xlabel('time (sec)')
                #         plt.ylabel('velocity (v/s)')
                #         plt.title('Second collision collider')
                #         plt.pause(0.000001)
                #         plt.draw()
                #     if(veh_id == 'accel1.0'):
                #         plt.axis([28, 35, 0, 80])
                ...
                #         plt.xlabel('time (sec)')
                #         plt.ylabel('velocity (v/s)')
                #         plt.title('Third collision collider')
                #         plt.pause(0.000001)
                #         plt.draw()
                #     if(veh_id == 'accel1.1'):
                #         plt.axis([48, 60, 0, 80])
                ...
                #         plt.xlabel('time (sec)')
                #         plt.ylabel('velocity (v/s)')
                #         plt.title('Forth collision collider')
                #         plt.pause(0.000001)
                #         plt.draw()
