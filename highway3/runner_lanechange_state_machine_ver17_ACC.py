...
def generate_routefile():
    ...
    with open("highway3.rou.xml", "w") as routes:
        ...
        <flow id="car0" departPos="free" begin="0.00" from="E4" to="E6" end="50.00" number="10" departSpeed="max" type="car" color="0,1,0"/>
        <flow id="car1" departPos="free" begin="0.00" from="E4" to="E8" end="50.00" number="10" departSpeed="max" type="car" color="0,1,0"/>
        <flow id="car2" departPos="free" begin="0.00" from="E7" to="E6" end="50.00" number="10" departSpeed="max" type="car" color="0,1,0"/>
        <flow id="car3" departPos="free" begin="0.00" from="E7" to="E8" end="50.00" number="10" departSpeed="max" type="car" color="0,1,0"/>
...
def save_csv():
    ...
    col_u = ['vehicle_id','time','input velocity','input acceleration','desire acceleration']
    ...
    os.chdir('C:/Users/jewoo/OneDrive/바탕 화면/SUMO/highway3/log_data/last_anti_rear_collision_dataset/1/checking2/8')
...
# def set_a(id,a_des): #return 값은 jerk 값을 고려한 현실적인 가속도 값을 반환한다.  -> chattering 발생
#     jerk = 3
#     dt = step_length
        ...
        for veh_id in vehs:
            ...
            if (traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 'c'):
                ...
                if traci.vehicle.getLeader(veh_id) is not None: # 선행 차량이 있을 때 ACC
                    ...
                    ### control input graph ###
                    control_input.append(None) #입력 속도
                    ...
                    ### control input graph ###
                    control_input.append(u[0]) # 입력 속도
                    control_input.append(u[1]) # 입력 가속도 
                    control_input.append(u[2]) # 목표 가속도
