...
class DQNAgent:
    def __init__(self, state_size, action_size):
        ...
        # 리플레이 메모리, 최대 크기 100
        self.memory = deque(maxlen=30000*7)
        self.memory0 = deque(maxlen= 30000)
        self.memory1 = deque(maxlen= 30000)
        self.memory2 = deque(maxlen= 30000)
        self.memory3 = deque(maxlen= 30000)
        self.memory4 = deque(maxlen= 30000)
        self.memory5 = deque(maxlen= 30000)
        self.memory6 = deque(maxlen= 30000)
