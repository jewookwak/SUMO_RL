# envs/validation/validationEnv2.py
import os
import sys
import time
...
class validationEnv2():
    ...
    # vehicles_tau=[random.uniform(0.74,2.27),random.uniform(0.74,2.27),0.74,0.74,random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),0.74,0.74,0.74,0.74,0.74,0.74]
    ...
    rear_tau_aggresive = random.uniform(0.1, 0.3)
    rear_tau_safe = random.uniform(0.75, 2.75)
    ...
    def reset(self):
        ...
        #initiate values of class validationEnv2.
        validationEnv2.Rule_RL = []
        validationEnv2.last_state =[]
        validationEnv2.lane_buffer_ego = 0
        validationEnv2.ego_LC_success = False
        validationEnv2.ego_LC_start = False
        validationEnv2.ego_LC_completed = False
        validationEnv2.last_Space1=0
        validationEnv2.last_Space2=0
        validationEnv2.last_Space3=0
        validationEnv2.last_Space4=0
        validationEnv2.last_safe_Space1=0
        validationEnv2.last_safe_Space2=0
        validationEnv2.last_safe_Space3=0
        validationEnv2.last_safe_Space4=0
        validationEnv2.S=[0,0,0,0,0,0,0,0,0]
        validationEnv2.ego_at_Target=[0,0,0,0]
        validationEnv2.integral_clearance_e=[0,0,0,0,0]
        validationEnv2.integral_velocity_e=[0,0,0,0,0]
        validationEnv2.pre_error_clearance = [0,0,0,0,0]
        validationEnv2.pre_error_velocity = [0,0,0,0,0]
        validationEnv2.ego_control=[]
        validationEnv2.ego=[]
        validationEnv2.left0=[]
        validationEnv2.left1=[]
        validationEnv2.left2=[]
        validationEnv2.left3=[]
        validationEnv2.left4=[]
        validationEnv2.left5=[]
        validationEnv2.left6=[]
        validationEnv2.left7=[]
        validationEnv2.rear=[]
        validationEnv2.right0=[]
        validationEnv2.right1=[]
        validationEnv2.forward=[]
        validationEnv2.right2=[]
        validationEnv2.right3=[]
        validationEnv2.right4=[]
        validationEnv2.right5=[]
        validationEnv2.right6=[]
        validationEnv2.right7=[]
        validationEnv2.Target1=[]
        validationEnv2.Target2=[]
        validationEnv2.Target3=[]
        validationEnv2.Target4=[]
        validationEnv2.Target_left_car = ""
        validationEnv2.Target_right_car =""
        validationEnv2.last_action = [[0,0]]
        validationEnv2.Left_action = False
        validationEnv2.Right_action = False
        validationEnv2.rewards =[]
        validationEnv2.toward_space_reward=[]
        validationEnv2.toward_space_reward_long=[]
        validationEnv2.toward_space_reward_lat=[]
        validationEnv2.t_LC_start =0
        validationEnv2.initial_x = 0
        validationEnv2.initial_y = 0
        validationEnv2.initial_target_y =0
        validationEnv2.theta_i=0
        validationEnv2.final_x =9999
        validationEnv2.final_y = 0
        validationEnv2.step_num = 0
        validationEnv2.coefficient=[0,0,0,0]
        validationEnv2.x_final = 0
        validationEnv2.crosstrack_error_term=[]
        validationEnv2.heading_error_term=[]
        validationEnv2.delta_term = []
        validationEnv2.clearance_error_term =[]
        validationEnv2.velocity_error_term = []    
        validationEnv2.Time=[]
        validationEnv2.Right_SD = False
        validationEnv2.Left_SD = False
        validationEnv2.Front_SD = True
        validationEnv2.last_target_space =[0,0]
        validationEnv2.last_vehicles = ['','']
        validationEnv2.mode=[0,0,0,0,0,0]
        # validationEnv2.vehicles_tau=[random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27)]
        # validationEnv2.vehicles_tau=[random.uniform(0.74,2.27),random.uniform(0.74,2.27),0.74,0.74,random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),random.uniform(0.74,2.27),0.74,0.74,0.74,0.74,0.74,0.74]
        validationEnv2.vehicles_tau=[1.36]*20 ########### RL 검증
        # validationEnv2.tau_random = [random.uniform(0,1),random.uniform(0,1),random.uniform(0,1),random.uniform(0,1),random.uniform(0,1),random.uniform(0,1),random.uniform(0,1),random.uniform(0,1)]
        validationEnv2.tau_random = [1]*8
        validationEnv2.rearMaxSpeed = random.uniform(29.17,33.33)
        validationEnv2.rear_collision_mode =  random.randint(0, 1)
        validationEnv2.rear_tau_aggresive = random.uniform(0.1, 0.5)
        validationEnv2.rear_tau_safe = random.uniform(0.75, 2.75)
        validationEnv2.rear_sleep =  random.randint(0, 1)
        validationEnv2.None_collision = True
        # if self.episode!=0: 
        #     self.sumo.close()
        #     sys.stdout.flush()
    ...
    def save_action_csv(self,episode,name):
        ...
        df_ego_action = pd.DataFrame(validationEnv2.last_action,columns=col_action)
    ...
    def save_csv(self,episode,name):
        ...
        df_ego = pd.DataFrame(validationEnv2.ego,columns=col)
        df_rear = pd.DataFrame(validationEnv2.rear,columns=col)
        df_forward = pd.DataFrame(validationEnv2.forward,columns=col)
        df_left0 = pd.DataFrame(validationEnv2.left0,columns=col)
        df_left1 = pd.DataFrame(validationEnv2.left1,columns=col)
        df_left2 = pd.DataFrame(validationEnv2.left2,columns=col)
        df_left3 = pd.DataFrame(validationEnv2.left3,columns=col)
        df_left4 = pd.DataFrame(validationEnv2.left4,columns=col)
        df_left5 = pd.DataFrame(validationEnv2.left5,columns=col)
        df_left6 = pd.DataFrame(validationEnv2.left6,columns=col)
        df_left7 = pd.DataFrame(validationEnv2.left7,columns=col)
        df_right0 = pd.DataFrame(validationEnv2.right0,columns=col)
        df_right1 = pd.DataFrame(validationEnv2.right1,columns=col)
        df_right2 = pd.DataFrame(validationEnv2.right2,columns=col)
        df_right3 = pd.DataFrame(validationEnv2.right3,columns=col)
        df_right4 = pd.DataFrame(validationEnv2.right4,columns=col)
        df_right5 = pd.DataFrame(validationEnv2.right5,columns=col)
        df_right6 = pd.DataFrame(validationEnv2.right6,columns=col)
        df_right7 = pd.DataFrame(validationEnv2.right7,columns=col)
        df_target1 = pd.DataFrame(validationEnv2.Target1,columns=col_target)
        df_target2 = pd.DataFrame(validationEnv2.Target2,columns=col_target)
        df_target3 = pd.DataFrame(validationEnv2.Target3,columns=col_target)
        df_target4 = pd.DataFrame(validationEnv2.Target4,columns=col_target)
        df_ego_control = pd.DataFrame(validationEnv2.ego_control,columns=col_control)
        df_ego_action = pd.DataFrame(validationEnv2.last_action,columns=col_action)
        df_reward = pd.DataFrame(validationEnv2.rewards,columns=col_reward)
        df_space_reward = pd.DataFrame(validationEnv2.toward_space_reward,columns=col_space_reward)
        df_space_reward_long = pd.DataFrame(validationEnv2.toward_space_reward_long,columns=col_space_reward)
        df_space_reward_lat = pd.DataFrame(validationEnv2.toward_space_reward_lat,columns=col_space_reward)
    ...
    def __ego_vehicle_LC_start(self):
        ...
        if 'ego' in vehs:
            ...
            last_lane = validationEnv2.lane_buffer_ego
    ...
    def __ego_vehicle_LC_completed(self,action):
        vehs = traci.vehicle.getIDList()
        if 'ego' in vehs:
            if validationEnv2.ego_LC_start == True:
                ...
                # if ((traci.vehicle.getLaneIndex('ego')== 2 and (action == 1 or action == 3)) or (traci.vehicle.getLaneIndex('ego')== 0 and (action == 2 or action == 4))):
                    validationEnv2.ego_LC_completed =True
                    self.done = True
    ...
    def __get_a_x(self,id):
        dt = self.step_length
        if(len(validationEnv2.ego)!=0):
            v_x_cur = (traci.vehicle.getPosition(id)[0] - validationEnv2.ego[-1][2])/dt
            a_x_cur = (v_x_cur -validationEnv2.ego[-1][4])/dt
        else:
            v_x_cur=0
            a_x_cur=0
        return a_x_cur
    ...
    def __get_a_y(self,id):
        dt = self.step_length
        if(len(validationEnv2.ego)!=0):
            v_y_cur = (traci.vehicle.getPosition(id)[1] - validationEnv2.ego[-1][3])/dt
            a_y_cur = (v_y_cur -validationEnv2.ego[-1][5])/dt
        else:
            v_y_cur=0
            a_y_cur=0
        return a_y_cur
    ...
    def __set_a_y_possible(self,id,a_y_des): #id =='ego'
        ...
        if(len(validationEnv2.ego)!=0):
            v_y_cur = (traci.vehicle.getPosition(id)[1] - validationEnv2.ego[-1][3])/dt
            a_y_cur = (v_y_cur -validationEnv2.ego[-1][5])/dt
            # print("validationEnv2.ego[-1][5]): ",validationEnv2.ego[-1][5])
            # print("validationEnv2.ego[-1][3]: ",validationEnv2.ego[-1][3])
        else:
            v_y_cur=0
            a_y_cur=0
        #     print("validationEnv2.ego[-1][5]): None")
        #     print("validationEnv2.ego[-1][3]: None")
    ...
    def __current_goal_space_point(self,action): # action ==1 or action == 2 or action == 3 or action == 4
        ...
        if 'ego' in vehs:
            ...
            if len(validationEnv2.last_action) ==0:
                LLP = 0
            else:
        ...
        if 'ego' in vehs:
            ...
            if lane == 0 and LLP <0:
                if action == 5:
                    ...
                    traci.vehicle.unsubscribeContext(str(id), tc.CMD_GET_VEHICLE_VARIABLE, 300.0)
                    validationEnv2.last_target_space =left_target_space
                    validationEnv2.last_vehicles =vehicles
                    ...
                    print("Wrong action!!")
                    traci.vehicle.unsubscribeContext(str(id), tc.CMD_GET_VEHICLE_VARIABLE, 300.0)
                    validationEnv2.last_target_space =right_target_space
                    validationEnv2.last_vehicles =vehicles
                    return right_target_space, vehicles
                else:
                    traci.vehicle.unsubscribeContext(str(id), tc.CMD_GET_VEHICLE_VARIABLE, 300.0)
                    return validationEnv2.last_target_space , validationEnv2.last_vehicles
    ...
    #     x_t = validationEnv2.ego[-1][3]
    #     v_x_cur = traci.vehicle.getSpeed('ego')
    #     a_x_cur = traci.vehicle.getAcceleration('ego')
    #     x_t += validationEnv2.ego[-1][3] - validationEnv2.ego[-2][3]
    ...
    def __ego_a_desire(self, v_c,v_t,c_d,c,space_num): # desire acceleration by ACC, v_c : ego_vehicle's velocity, v_t : target velocity, c_d : desire clearance, c = actual clearance
        ...
        Kd = 0.005
        Kd2 = 0.7
        validationEnv2.integral_clearance_e[space_num] += Ki*(c_d -c)*self.step_length
        validationEnv2.integral_velocity_e[space_num] += Ki2*(v_t-v_c)*self.step_length

        clearance_error = (c_d -c)
        velocity_error = (v_t-v_c)
        if len(validationEnv2.pre_error_velocity)>0 and len(validationEnv2.pre_error_velocity)>0:
            a_d = -P*self.__K1(v_c)*(c_d-c) - P2*self.__K2(v_c)*(v_t-v_c) -validationEnv2.integral_clearance_e[space_num] +validationEnv2.integral_velocity_e[space_num] -Kd*(clearance_error-validationEnv2.pre_error_clearance[space_num])/self.step_length +Kd2*(velocity_error-validationEnv2.pre_error_velocity[space_num])
        else:
            a_d = -P*self.__K1(v_c)*(c_d-c) - P2*self.__K2(v_c)*(v_t-v_c) -validationEnv2.integral_clearance_e[space_num] +validationEnv2.integral_velocity_e[space_num]
        ...
        if(a_d >3):
            ...
            return -5
        validationEnv2.pre_error_clearance[space_num] = (c_d -c)
        validationEnv2.pre_error_velocity[space_num] = (v_t-v_c)
    ...
    def __ego_a_desire2(self, v_c,v_t,c_d,c,space_num): # desire acceleration by ACC, v_c : ego_vehicle's velocity, v_t : target velocity, c_d : desire clearance, c = actual clearance
        ...
        # print('ego_v: ',v_c)
        # print('target_v: ',v_t)
        validationEnv2.clearance_error_term.append(-P*self.__K1(v_c)*(c_d-c))
        validationEnv2.velocity_error_term.append(-P2*self.__K2(v_c)*(v_t-v_c))
        validationEnv2.Time.append(traci.simulation.getTime())
        # plt.figure(1,figsize=(8,4))            
        # pylab.plot(validationEnv2.Time, validationEnv2.clearance_error_term, 'r',label='c_error_term')
        # pylab.plot(validationEnv2.Time, validationEnv2.velocity_error_term, 'b',label='vel_error_term')
    ...
    def __rear_vehicle_random_collsion(self, veh_id):
        ...
        # validationEnv2.rear_collision_mode = self.episode%2
        # 색상 설정
        if validationEnv2.rear_collision_mode == 1:  # 충돌 모드
            # 빨간색 계열
        ...
        if 'ego' in vehs:  # 선행 차량이 있을 때 ACC
            ...
            if validationEnv2.rear_collision_mode == 1:  # 충돌 모드
                # 위험한 tau 값 (0.1~0.5초)
                tau = validationEnv2.rear_tau_aggresive
                # 충돌 가능성 높은 차량은 로깅
                # print(f"[위험] 차량 {veh_id} - 충돌 모드, tau: {tau:.2f}초, 간격: {c_front:.2f}m")
                
            else:  # 안전 모드
                # 안전한 tau 값 (1.5~2.5초)
                tau = validationEnv2.rear_tau_safe
                # 안전 모드 차량 로깅
            ...
            # 비충돌 모드일 경우 감속 강화
            if validationEnv2.rear_collision_mode == 0 and time_to_collision < 2.0 and a_des<0:
                a_des = -9  # 풀브레이킹

             # 충돌 모드일 경우 감속 약화 (더 공격적인 주행)
            if validationEnv2.rear_collision_mode == 1 and a_des < 0:
                if validationEnv2.rear_sleep == 1:
                    a_des = 0
                else:
    ...
    def __setvehiclestate(self, id):
        ...
        if leader_info is not None:
            leader_id, gap = leader_info  # gap은 미터 단위의 거리
            v_current = traci.vehicle.getSpeed(id)  # 현재 속도 (m/s)
            v_leader = traci.vehicle.getSpeed(leader_id)  # 앞차 속도 (m/s)
            
            # 충돌/비충돌을 약 1:1 비율로 설정
            # 무작위로 0 또는 1 선택 (50% 확률)
            # collision_mode = random.randint(0, 1)
            
            if validationEnv2.rear_collision_mode == 1:  # 충돌 시나리오
                traci.vehicle.setColor(id,(255, 0, 0, 255))
                # 충돌 가능성이 높은 위험한 tau 범위 설정 (0.1~0.5초)
                if v_current > 0.1:
                    desired_tau = random.uniform(0.1, 0.5)
                    # 목표 간격 계산
                    desired_gap = desired_tau * v_current
                    # 가속도 계산 - 충돌 가능성 높게
                    gap_diff = gap - desired_gap
                    a_des = -2.0 + gap_diff  # 간격이 작을수록 약한 감속(충돌 유도)
                    a_des = max(-4.0, min(2.0, a_des))  # 가속도 범위 제한
                else:
                    # 속도가 매우 낮을 때는 약간 가속
                    a_des = random.uniform(0.3, 0.7)
            else:  # 비충돌 시나리오
                traci.vehicle.setColor(id,(0, 0, 255, 255))
                # 안전한 tau 범위 설정 (1.5~3.0초)
                if v_current > 0.1:
                    desired_tau = random.uniform(2.0, 3.0)
                    # 목표 간격 계산
                    desired_gap = desired_tau * v_current
                    # 가속도 계산 - 안전하게 유지
                    gap_diff = gap - desired_gap
                    a_des = gap_diff * 0.7  # 간격에 비례한 가속/감속
                    a_des = max(-3.0, min(1.5, a_des))  # 가속도 범위 제한
                else:
                    # 속도가 매우 낮을 때는 보통 가속
                    a_des = random.uniform(0.5, 1.0)
            
            # 현재 시뮬레이션 시간 확인 (디버깅용)
            sim_time = traci.simulation.getTime()
            
            # 로그 출력 (디버깅용)
            # print(f"Time: {sim_time:.2f}, Vehicle: {id}, Mode: {'Collision' if validationEnv2.rear_collision_mode==1 else 'Safe'}, " 
            #     f"Gap: {gap:.2f}m, Tau: {desired_tau:.2f}s, a_des: {a_des:.2f}m/s²")
            
            # 저크(jerk) 제한으로 부드러운 가속/감속
            jerk = random.uniform(1, 1.5)
            a_cur = traci.vehicle.getAcceleration(id)
            ...
            # 앞차가 없는 경우 자유 주행
            v_current = traci.vehicle.getSpeed(id)
            v_desired = traci.vehicle.getAllowedSpeed(id) * 0.9  # 제한 속도의 90%로 주행
            
            # 일반적인 주행 가속도 설정
            if v_current < v_desired - 0.5:
                a_des = min(1.5, (v_desired - v_current) / 3)
            elif v_current > v_desired + 0.5:
                a_des = max(-1.0, (v_desired - v_current) / 3)
            else:
                a_des = 0  # 속도 유지
    ...
    def __set_ego_a_movetoXY(self,id,a_des): #return 값은 jerk 값을 고려한 현실적인 가속도 값을 반환한다. # SUMO에 가속도를 입력한다.
        ...
        if len(validationEnv2.ego)!=0:
            last_x = validationEnv2.ego[-1][2]
            last_y = validationEnv2.ego[-1][3]
            v_y_cur = (traci.vehicle.getPosition(id)[1] - validationEnv2.ego[-1][3])/dt
            a_y_cur = (v_y_cur -validationEnv2.ego[-1][5])/dt
        else:
            last_x = x_cur
        ...
        # print('y_cur: ',y_cur)
        # if len(validationEnv2.ego) != 0:
        #     if validationEnv2.ego[-1][8]<90:
        #         angle = validationEnv2.ego[-1][8] +4*dt
        #     elif validationEnv2.ego[-1][8]>90:
        #         angle = validationEnv2.ego[-1][8] -4*dt
        #     else:
        #         angle =90
        # else:
...
########################################################
        ...
        if(a_cur+jerk*dt<a_des):
            ...
            x_next = x_cur +v_next*dt 
            # return a_des
        # theta = np.arctan2(y_cur-validationEnv2.ego[-1][3],x_cur-validationEnv2.ego[-1][2])
        # if(y_cur-validationEnv2.ego[-1][3]>=0):
        #     angle = 90-theta*30
        # else:
        #     angle = 90-theta*30
        # print("angle:::::::::::::::::",angle)
    ...
    def __set_ego_a_movetoXY2(self,id,a_des,action): #return 값은 jerk 값을 고려한 현실적인 가속도 값을 반환한다. # SUMO에 가속도를 입력한다.
        ...
        if action == 1  and lane == 2 and x_cur > traci.vehicle.getPosition(validationEnv2.Target_left_car)[0] + epsilon_d:
            target_lane_y = -1.6
        if action == 3 and lane == 2 and x_cur < traci.vehicle.getPosition(validationEnv2.Target_left_car)[0] - epsilon_d:
            target_lane_y = -1.6
        if action == 2 and lane == 0 and x_cur > traci.vehicle.getPosition(validationEnv2.Target_right_car)[0] + epsilon_d:
            target_lane_y = -8
        if action == 4 and lane == 0 and x_cur < traci.vehicle.getPosition(validationEnv2.Target_right_car)[0] - epsilon_d:
            target_lane_y = -8
...
########################################################
    ...
    def state(self,id = 'ego'):
        states = []
        vehs = traci.vehicle.getIDList()
        if id in vehs and validationEnv2.Target_left_car in vehs and validationEnv2.Target_right_car in vehs:
            if traci.vehicle.getLeader(validationEnv2.Target_left_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==2:
                left_leader = traci.vehicle.getLeader('ego')[0]
            elif traci.vehicle.getLeader(validationEnv2.Target_left_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==1:
                left_leader = 'car.left'+str(int(validationEnv2.Target_left_car[-1])+1)
            else:
                left_leader = traci.vehicle.getLeader(validationEnv2.Target_left_car)[0]
            if traci.vehicle.getFollower(validationEnv2.Target_left_car)[0] =='ego' and traci.vehicle.getLaneIndex('ego')==2:
                left_follower = traci.vehicle.getFollower('ego')[0]
            elif traci.vehicle.getFollower(validationEnv2.Target_left_car)[0] =='ego' and traci.vehicle.getLaneIndex('ego')==1:
                left_follower = 'car.left'+str(int(validationEnv2.Target_left_car[-1])-1)
            else:
                left_follower = traci.vehicle.getFollower(validationEnv2.Target_left_car)[0]
            
            if traci.vehicle.getLeader(validationEnv2.Target_right_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==0:
                right_leader = traci.vehicle.getLeader('ego')[0]
            elif traci.vehicle.getLeader(validationEnv2.Target_right_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==1:
                right_leader = 'car.right'+str(int(validationEnv2.Target_right_car[-1])+1)
            else:
                right_leader = traci.vehicle.getLeader(validationEnv2.Target_right_car)[0]
            if traci.vehicle.getFollower(validationEnv2.Target_right_car)[0] =='ego' and traci.vehicle.getLaneIndex('ego')==0:
                right_follower = traci.vehicle.getFollower('ego')[0]
            elif traci.vehicle.getFollower(validationEnv2.Target_right_car)[0] =='ego' and traci.vehicle.getLaneIndex('ego')==1:
                right_follower = 'car.right'+str(int(validationEnv2.Target_right_car[-1])-1)
            else:
                right_follower = traci.vehicle.getFollower(validationEnv2.Target_right_car)[0]
            ...
            # if rear_rel_x == None and len(validationEnv2.rear) !=0:
            #     for sublist in reversed(validationEnv2.rear):
            #         if sublist[2] == None:
            #             pass
            #         else:
            ...
            left_rel_x, left_rel_y = np.asarray(traci.vehicle.getPosition(validationEnv2.Target_left_car)) - np.asarray(traci.vehicle.getPosition('ego'))
            left_v = traci.vehicle.getSpeed(validationEnv2.Target_left_car)
            ...
            right_rel_x, right_rel_y = np.asarray(traci.vehicle.getPosition(validationEnv2.Target_right_car)) - np.asarray(traci.vehicle.getPosition('ego'))
            right_v = traci.vehicle.getSpeed(validationEnv2.Target_right_car)
            ...
            s1_rel_x, s1_rel_y = ((traci.vehicle.getPosition(validationEnv2.Target_left_car)[0] + traci.vehicle.getPosition(left_leader)[0])/2 - traci.vehicle.getPosition('ego')[0]), (traci.vehicle.getPosition(validationEnv2.Target_left_car)[1]- traci.vehicle.getPosition('ego')[1])
            s1_v = (traci.vehicle.getSpeed(validationEnv2.Target_left_car) + traci.vehicle.getSpeed(left_leader))/2
            s2_rel_x, s2_rel_y = ((traci.vehicle.getPosition(validationEnv2.Target_right_car)[0] + traci.vehicle.getPosition(right_leader)[0])/2 - traci.vehicle.getPosition('ego')[0]), (traci.vehicle.getPosition(validationEnv2.Target_right_car)[1]- traci.vehicle.getPosition('ego')[1])
            s2_v = (traci.vehicle.getSpeed(validationEnv2.Target_right_car) + traci.vehicle.getSpeed(right_leader))/2
            s3_rel_x, s3_rel_y = ((traci.vehicle.getPosition(validationEnv2.Target_left_car)[0] + traci.vehicle.getPosition(left_follower)[0])/2 - traci.vehicle.getPosition('ego')[0]), (traci.vehicle.getPosition(validationEnv2.Target_left_car)[1]- traci.vehicle.getPosition('ego')[1])
            s3_v = (traci.vehicle.getSpeed(validationEnv2.Target_left_car) + traci.vehicle.getSpeed(left_follower))/2
            s4_rel_x, s4_rel_y = ((traci.vehicle.getPosition(validationEnv2.Target_right_car)[0] + traci.vehicle.getPosition(right_follower)[0])/2 - traci.vehicle.getPosition('ego')[0]), (traci.vehicle.getPosition(validationEnv2.Target_right_car)[1]- traci.vehicle.getPosition('ego')[1])
            s4_v = (traci.vehicle.getSpeed(validationEnv2.Target_right_car) + traci.vehicle.getSpeed(right_follower))/2
            ...
            space1_size = np.abs((traci.vehicle.getPosition(validationEnv2.Target_left_car)[0] - traci.vehicle.getPosition(left_leader)[0]))
            space2_size = np.abs((traci.vehicle.getPosition(validationEnv2.Target_right_car)[0] - traci.vehicle.getPosition(right_leader)[0]))
            space3_size = np.abs((traci.vehicle.getPosition(validationEnv2.Target_left_car)[0] - traci.vehicle.getPosition(left_follower)[0]))
            space4_size = np.abs((traci.vehicle.getPosition(validationEnv2.Target_right_car)[0] - traci.vehicle.getPosition(right_follower)[0]))
        ...
        validationEnv2.last_state = states
    ...
    def __toward_empty_space_reward(self, id, action):
        ...
        def reward_for_space(space_size, ego_pos, action, sd_lc_dist, dist_to_space, weight, action_codes):
            longitudinal_term = 1 if (
                (action_codes[0] == 'L' and action == 3 and (ego_pos[0] < traci.vehicle.getPosition(validationEnv2.Target_left_car)[0] - self.SD_LC_with_respect_to_target_space('ego', 3, 'front') and ego_pos[0] > traci.vehicle.getPosition(left_follower)[0] + self.SD_LC_with_respect_to_target_space('ego', 3,'back'))) or
                (action_codes[0] == 'L' and action == 1 and (ego_pos[0] > traci.vehicle.getPosition(validationEnv2.Target_left_car)[0] + self.SD_LC_with_respect_to_target_space('ego', 1,'back') and ego_pos[0] < traci.vehicle.getPosition(left_leader)[0] - self.SD_LC_with_respect_to_target_space('ego', 1,'front'))) or
                (action_codes[0] == 'R' and action == 4 and (ego_pos[0] < traci.vehicle.getPosition(validationEnv2.Target_right_car)[0] - self.SD_LC_with_respect_to_target_space('ego', 4,'front') and ego_pos[0] > traci.vehicle.getPosition(right_follower)[0] + self.SD_LC_with_respect_to_target_space('ego', 4,'back'))) or
                (action_codes[0] == 'R' and action == 2 and (ego_pos[0] > traci.vehicle.getPosition(validationEnv2.Target_right_car)[0] + self.SD_LC_with_respect_to_target_space('ego', 2,'back') and ego_pos[0] < traci.vehicle.getPosition(right_leader)[0] - self.SD_LC_with_respect_to_target_space('ego', 2,'front')))
            ) else 2 ** (-sd_lc_dist)
        ...
        if id in vehs and validationEnv2.Target_left_car in vehs and validationEnv2.Target_right_car in vehs:
            ...
            spaces = [
                [get_space_size(validationEnv2.Target_left_car, left_leader), get_midpoint_distance(validationEnv2.Target_left_car, left_leader, ego_pos), 'L1',get_target_car_forward_SD_LC_point_distance(validationEnv2.Target_left_car, ego_pos, self.SD_LC_with_respect_to_target_space('ego', 1,'back'))],
                [get_space_size(validationEnv2.Target_right_car, right_leader), get_midpoint_distance(validationEnv2.Target_right_car, right_leader, ego_pos), 'R1',get_target_car_forward_SD_LC_point_distance(validationEnv2.Target_left_car, ego_pos, self.SD_LC_with_respect_to_target_space('ego', 2,'back'))],
                [get_space_size(validationEnv2.Target_left_car, left_follower), get_midpoint_distance(validationEnv2.Target_left_car, left_follower, ego_pos), 'L2',get_target_car_rear_SD_LC_point_distance(validationEnv2.Target_left_car, ego_pos, self.SD_LC_with_respect_to_target_space('ego', 3,'front'))],
                [get_space_size(validationEnv2.Target_right_car, right_follower), get_midpoint_distance(validationEnv2.Target_right_car, right_follower, ego_pos), 'R2',get_target_car_rear_SD_LC_point_distance(validationEnv2.Target_left_car, ego_pos, self.SD_LC_with_respect_to_target_space('ego', 4,'front'))]
            ]
            spaces.sort()

            

            space_weights = [1, 0.75, 0, 0] # validation 
            # w_l = 0.2
            w_l =2
            ...
            for i, space in enumerate(spaces): # validation !!!!!
                if (space[2] == 'L1' and action == 1) or (space[2] == 'R1' and action == 2) or (space[2] == 'L2' and action == 3) or (space[2] == 'R2' and action == 4):
                    reward, long_term, lat_term = reward_for_space(
                        space[0], ego_pos, action, space[3], space[1], space_weights[i], space[2]
                    )
                    value += reward
        ...
        validationEnv2.toward_space_reward.append(space_reward)
        validationEnv2.toward_space_reward_long.append(space_reward_long)
        validationEnv2.toward_space_reward_lat.append(space_reward_lat)
    ...
    def __chosen_space_size_reward(self): #시뮬레이션 시작 처음 근접 좌우 차량 기준 앞뒤 공간으로 차로 변경 시 보상.
        vehs = traci.vehicle.getIDList()
        if validationEnv2.Target_left_car in vehs and validationEnv2.Target_right_car in vehs and 'ego' in vehs:
            if traci.vehicle.getLeader(validationEnv2.Target_left_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==2:
                left_leader = traci.vehicle.getLeader('ego')[0]
            elif traci.vehicle.getLeader(validationEnv2.Target_left_car)[0] == 'ego' and traci.vehicle.getLaneIndex('ego')==1:
                left_leader = 'car.left'+str(int(validationEnv2.Target_left_car[-1])+1)
            ...
            if traci.vehicle.getLaneIndex('ego') == 2:
                if traci.vehicle.getPosition('ego')[0] > traci.vehicle.getPosition(validationEnv2.Target_left_car)[0]:
                    ego_chosen_space = 'L1'
                else:
                    ego_chosen_space = 'L2'
            if traci.vehicle.getLaneIndex('ego') == 0:
                if traci.vehicle.getPosition('ego')[0] > traci.vehicle.getPosition(validationEnv2.Target_right_car)[0]:
                    ego_chosen_space = 'R1'
                else:
                    ego_chosen_space = 'R2'
    ...
    def SD_LC_with_respect_to_target_space(self,id,action,direction): #action 1~4 = target space 1~4, action 에 따라 SD_LC를 return /// direction은 해당 action의 SD 중 앞에 것, 뒤에 것중 하나를 지정.
        ...
        if validationEnv2.Target_left_car in vehs and validationEnv2.Target_right_car in vehs and 'ego' in vehs:  
            if action == 1 and direction == 'back':
                relative_velocity_term = max([traci.vehicle.getSpeed(validationEnv2.Target_left_car)-traci.vehicle.getSpeed(id),0] )*time_gap_LC_1
                minimum_clearance_trem = max([traci.vehicle.getSpeed(validationEnv2.Target_left_car)*time_gap_LC_2,c_LC])
                SD_LC_back = relative_velocity_term + minimum_clearance_trem
                # print('space1 SD_LC: ',SD_LC)
                # space1_size = (traci.vehicle.getPosition(traci.vehicle.getLeader(validationEnv2.Target_left_car)[0])[0] -traci.vehicle.getPosition(validationEnv2.Target_left_car)[0])
                ...
                relative_velocity_term = max([traci.vehicle.getSpeed(validationEnv2.Target_right_car)-traci.vehicle.getSpeed(id),0] )*time_gap_LC_1
                minimum_clearance_trem = max([traci.vehicle.getSpeed(validationEnv2.Target_right_car)*time_gap_LC_2,c_LC])
                SD_LC_back = relative_velocity_term + minimum_clearance_trem
                # print('space2 SD_LC: ',SD_LC)
                # space2_size = (traci.vehicle.getPosition(traci.vehicle.getLeader(validationEnv2.Target_right_car)[0])[0] -traci.vehicle.getPosition(validationEnv2.Target_right_car)[0])
                ...
                relative_velocity_term = max( [traci.vehicle.getSpeed(id) - traci.vehicle.getSpeed(validationEnv2.Target_left_car) ,0] )*time_gap_LC_1
                minimum_clearance_trem = max([traci.vehicle.getSpeed(id)*time_gap_LC_2,c_LC])
                SD_LC_front = relative_velocity_term +minimum_clearance_trem
                # print('space3 SD_LC: ',SD_LC)
                # space3_size = (traci.vehicle.getPosition(validationEnv2.Target_left_car)[0]-traci.vehicle.getPosition(traci.vehicle.getFollower(validationEnv2.Target_left_car)[0])[0])
                ...
                relative_velocity_term = max( [traci.vehicle.getSpeed(id) - traci.vehicle.getSpeed(validationEnv2.Target_right_car) ,0] )*time_gap_LC_1
                minimum_clearance_trem = max([traci.vehicle.getSpeed(id)*time_gap_LC_2,c_LC])
                SD_LC_front = relative_velocity_term +minimum_clearance_trem
                # print('space4 SD_LC: ',SD_LC)
                # space4_size = (traci.vehicle.getPosition(validationEnv2.Target_right_car)[0]-traci.vehicle.getPosition(traci.vehicle.getFollower(validationEnv2.Target_right_car)[0])[0])
    ...
    def __SD_check(self,action):
        if (action == 1 or action == 3) and validationEnv2.Left_action == True:
            action = 5
        if (action == 2 or action == 4) and validationEnv2.Right_action == True:
            action = 6
        id = 'ego'
        time_gap_LC_1 =1
        time_gap_LC_2 =0.5 
    ...
    def __reward(self, step_num, action):
        ...
        # 가중치 설정
        w1 = 0.0   # collision negative reward
        w2 = 0.0   # SD_LC not satisfied negative reward
        w2_1 = 0.0 # SD_LK not satisfied negative reward
        w3 = 0.1    # distance to biggest empty space positive reward - 증가됨 (0.2->0.3)
        w4 = 0.0    # Rear_TTC risk negative reward
        w5 = 0.0   # LK when no danger detected
        w6 = 0.0   # LC succeed positive reward
        ...
        with self.summary_writer.as_default():
            ...
            tf.summary.scalar('state/left_sd', float(validationEnv2.Left_SD), step=step)
            tf.summary.scalar('state/right_sd', float(validationEnv2.Right_SD), step=step)
            tf.summary.scalar('state/front_sd', float(validationEnv2.Front_SD), step=step)
        ...
        if len(traci.simulation.getCollidingVehiclesIDList()) != 0:
            log = traci.simulation.getCollisions()
            validationEnv2.None_collision = False
        ...
        if validationEnv2.None_collision == False:
        ...
        if('ego' in vehs and 'accel.rear' in vehs and 'car.forward' in vehs):
            if rear_collision_risk < 0.1:  # 충돌 위험이 매우 낮은 경우
                if (action == 5) and validationEnv2.Front_SD:
        ...
        if('ego' in vehs and 'accel.rear' in vehs):
            if (self.done and len(traci.simulation.getCollidingVehiclesIDList()) == 0):
                ...
                if chosen_space_info[1] == '1':
                    validationEnv2.space1_count += 1
                elif chosen_space_info[1] == '2':
                    validationEnv2.space2_count += 1
                elif chosen_space_info[1] == '3':
                    validationEnv2.space3_count += 1
                else:
                    validationEnv2.space4_count += 1
                    
                if chosen_space_info[2] == 'R1':
                    validationEnv2.R1_count += 1
                elif chosen_space_info[2] == 'R2':
                    validationEnv2.R2_count += 1
                elif chosen_space_info[2] == 'L1':
                    validationEnv2.L1_count += 1
                else:
                    validationEnv2.L2_count += 1
        ...
        if('ego' in vehs and 'accel.rear' in vehs):
            if len(validationEnv2.last_action) > 0 and rear_collision_risk > 0:
                if (((action == 1 or action == 3) and validationEnv2.Left_SD == True) or 
                    ((action == 2 or action == 4) and validationEnv2.Right_SD == True)):
                    if validationEnv2.Left_action == True and (action == 1 or action == 3):
                        if Lane == 1 and LLP > 0:
                    ...
                    elif validationEnv2.Right_action == False and (action == 2 or action == 4):
                        if Lane == 1 and LLP < 0:
                            target_lane_lateral_approaching_reward = -LLP * w7 * (1 + rear_collision_risk)
                        elif Lane == 0 and LLP > 0:
                            target_lane_lateral_approaching_reward = (3.2 - LLP) * w7 * (1 + rear_collision_risk)
        ...
        if('ego' in vehs and 'accel.rear' in vehs):
            if (traci.vehicle.getPosition('ego')[0] > traci.vehicle.getPosition('accel.rear')[0]) and validationEnv2.None_collision == True:
        ...
        # if ('ego' in vehs and 'accel.rear' in vehs and 'car.forward' in vehs):
        #     if(validationEnv2.Left_SD == False and validationEnv2.Right_SD == False ):
        ...
        # if len(validationEnv2.last_action) > 0:
        #     if ((Lane == 1 or Lane == 2) and action == 1 and validationEnv2.Left_action == True and validationEnv2.last_action[-1][1] == 1) or \
        #     ((Lane == 1 or Lane == 2) and action == 3 and validationEnv2.Left_action == True and validationEnv2.last_action[-1][1] == 3) or \
        #     ((Lane == 1 or Lane == 0) and action == 2 and validationEnv2.Right_action == True and validationEnv2.last_action[-1][1] == 2) or \
        #     ((Lane == 1 or Lane == 0) and action == 4 and validationEnv2.Right_action == True and validationEnv2.last_action[-1][1] == 4):
    ...
    #     if('ego' in vehs and 'accel.rear' in vehs):
    #         if traci.vehicle.getLaneIndex('ego') == 1:
    #             if(validationEnv2.ego_LC_success == False and rear_TTC <= 13.2 and rear_clearance >= 0 and traci.vehicle.getLaneIndex('ego') == 1):
    ...
    #     safe_lk_reward = 0
    #     if('ego' in vehs and 'accel.rear' in vehs):
    #         if(rear_TTC > 13.2 and (action == 5) and validationEnv2.Front_SD):
    ...
    #     if('ego' in vehs and 'accel.rear' in vehs):
    #         if len(validationEnv2.last_action) > 0 and rear_TTC < 13.2 and (((action == 1 or action == 3) and validationEnv2.Left_SD == True) or ((action == 2 or action == 4) and validationEnv2.Right_SD == True)):
    #             if validationEnv2.Left_action == True and (action == 1 or action == 3):
    #                 if Lane == 1 and LLP > 0:
    ...
    #     if('ego' in vehs and 'accel.rear' in vehs):
    #         if validationEnv2.None_collision == True:
    ...
    #     self.__SD_check(action)
    #     self.__Front_SD_check()
    #     # print('validationEnv2.Left_SD: ',validationEnv2.Left_SD )
    #     # print('validationEnv2.Right_SD: ',validationEnv2.Right_SD)
    #     # print('validationEnv2.Front_SD: ',validationEnv2.Front_SD)
    ...
    #             #     reward +=1*w4
    #             if(validationEnv2.ego_LC_success ==False and rear_TTC<=13.2 and rear_clearance >=0 and traci.vehicle.getLaneIndex('ego')==1): #후방 차량 충돌 판단 가능 범위
    ...
    #         if(rear_TTC>13.2 and (action == 5) and validationEnv2.Front_SD): #safe state LK positive reward                    
    ...
    #         if validationEnv2.None_collision == True: # if rear_clearance >=-30 episode ends
    #             reward += 30*w8
    #             Reward.append(30*w8)
    #         else:
    #             reward += 0
    ...
    #         Reward.append(0)
    #         reward +=0
    #     # print('validationEnv2.last_action: ',validationEnv2.last_action[-1][1])
    #     # print('validationEnv2.Left_action: ',validationEnv2.Left_action)
    #     # print('validationEnv2.Right_action: ',validationEnv2.Right_action)
    #     if ((Lane == 1 or Lane == 2) and action == 1 and validationEnv2.Left_action == True and validationEnv2.last_action[-1][1] == 1) or ((Lane == 1 or Lane == 2) and action == 3 and validationEnv2.Left_action == True and validationEnv2.last_action[-1][1] == 3) or ((Lane == 1 or Lane == 0) and action == 2 and validationEnv2.Right_action == True and validationEnv2.last_action[-1][1] == 2) or ((Lane == 1 or Lane == 0) and action == 4 and validationEnv2.Right_action == True and validationEnv2.last_action[-1][1] == 4):
    ...
    #     validationEnv2.rewards.append(Reward)
    #     return reward
    # def __reward(self, step_num, action):
    #     Reward = []
    ...
    #                     is_safe_LC = (action in [1, 3] and validationEnv2.Left_SD) or (action in [2, 4] and validationEnv2.Right_SD)
    ...
    #             if validationEnv2.ego_LC_success == False and collision_imminent and rear_clearance >= 0:
    #                 # 위험도에 따라 패널티 조정
    ...
    #         # 안전한 상황에서 LK에 대한 보상
    #         if not collision_imminent and (action == 5) and validationEnv2.Front_SD:
    ...
    #         # 차선 변경 진행에 대한 보상
    #         if len(validationEnv2.last_action) > 0 and collision_imminent and (
    #             ((action == 1 or action == 3) and validationEnv2.Left_SD) or 
    #             ((action == 2 or action == 4) and validationEnv2.Right_SD)
    #         ):                    
    #             if validationEnv2.Left_action and (action in [1, 3]):
    #                 if Lane == 1 and LLP > 0:
    #                     reward += LLP * w7
    #                     Reward.append(LLP * w7)
    #                 elif Lane == 2 and LLP < 0:
    ...
    #                     reward += 0
    #                     Reward.append(0)
    #             elif not validationEnv2.Right_action and (action in [2, 4]):
    #                 if Lane == 1 and LLP < 0:
    #                     reward += -LLP * w7
    #                     Reward.append(-LLP * w7)
    #                 elif Lane == 0 and LLP > 0:
    ...
    #         if validationEnv2.None_collision:
    #             # 추돌 위험이 있었으면 보상 증가
    ...
    #     if ((Lane == 1 or Lane == 2) and action == 1 and validationEnv2.Left_action and validationEnv2.last_action[-1][1] == 1) or \
    #     ((Lane == 1 or Lane == 2) and action == 3 and validationEnv2.Left_action and validationEnv2.last_action[-1][1] == 3) or \
    #     ((Lane == 1 or Lane == 0) and action == 2 and validationEnv2.Right_action and validationEnv2.last_action[-1][1] == 2) or \
    #     ((Lane == 1 or Lane == 0) and action == 4 and validationEnv2.Right_action and validationEnv2.last_action[-1][1] == 4):
    ...
    def LC_cubic_polynomial_path(self,x_initial,y_initial,x_final,y_final,rear_v_id,forward_v_id,theta_i,action):
        ...
        # print('t_LC: ',t_LC)
        validationEnv2.x_final = x_final
    ...
    def stanley(self,coef,heading_angle,x_cur,v_cur): #heading_angle(degree)
        if coef == [0,0,0,0]:
            ...
            soft_term=1
            if len(validationEnv2.ego) !=0:
                prev_delta = validationEnv2.ego[-1][8]
            else:
                prev_delta = 90
    ...
    def LC_Left(self,action,v_target,c_target):
        ...
        if('ego' in vehs):  
            ...
            if action == 5:
                ...
                if(len(validationEnv2.ego)!=0):
                    last_ego_x = validationEnv2.ego[-1][2]
                    last_ego_y = validationEnv2.ego[-1][3]
                    last_ego_v_y = validationEnv2.ego[-1][5]
                else:
                ...
                validationEnv2.last_target_space = xy
                validationEnv2.last_vehicles = ids
                target_x, target_y = xy[0],xy[1]
                rear_v_id,forward_v_id = ids
                if ego_x-validationEnv2.initial_x>=validationEnv2.final_x:
                    path_done = True
                else:
                    path_done = False
                ...
                if path_done == True and traci.vehicle.getLaneIndex('ego') ==1 and LLP <= 0 and LLP >= -0.4 and traci.vehicle.getAngle('ego')>=89.9:
                    print("---------------------------------------LC_succeed")
                    validationEnv2.initial_x = ego_x
                    validationEnv2.initial_y = ego_y
                    target_y = -1.6
                    validationEnv2.theta_i = (90-traci.vehicle.getAngle('ego'))*np.pi/180
                ...
                if validationEnv2.Left_action == False:
                    # print('validationEnv2.Left_action == False')
                    t = 0
                    validationEnv2.t_LC_start = traci.simulation.getTime()
                    x0=0
                    y0=0
                    validationEnv2.initial_x = ego_x
                    validationEnv2.initial_y = ego_y
                    validationEnv2.initial_target_y = target_y
                    validationEnv2.theta_i = (90-traci.vehicle.getAngle('ego'))*np.pi/180
                    validationEnv2.coefficient,validationEnv2.final_x,validationEnv2.final_y =self.LC_cubic_polynomial_path(validationEnv2.initial_x,validationEnv2.initial_y,target_x,target_y,rear_v_id,forward_v_id,validationEnv2.theta_i,action)
                else:
                    # print('validationEnv2.Left_action == True')
                    t= traci.simulation.getTime()-validationEnv2.t_LC_start
                    x0= validationEnv2.initial_x
                    y0= validationEnv2.initial_y
                    if path_done:                       
                        validationEnv2.coefficient = [target_y-ego_y,0,0,0]
                    if LC_succeed:                     
                        validationEnv2.coefficient,validationEnv2.final_x,validationEnv2.final_y =self.LC_cubic_polynomial_path(validationEnv2.initial_x,validationEnv2.initial_y,target_x,target_y,rear_v_id,forward_v_id,validationEnv2.theta_i,action)
                    
                x_local = ego_x - validationEnv2.initial_x
                # delta = self.stanley(validationEnv2.coefficient,traci.vehicle.getAngle('ego'),x_local,ego_v)
                x = ego_x -validationEnv2.initial_x
                y = validationEnv2.coefficient[2]*x**2+validationEnv2.coefficient[3]*x**3
                y_prime = 2*validationEnv2.coefficient[2]*x+3*validationEnv2.coefficient[3]*x**2
                y_pprime = 2*validationEnv2.coefficient[2]+6*validationEnv2.coefficient[3]*x
                ...
                validationEnv2.ego_control.append(control)
                theta = np.arctan2(ego_y-last_ego_y,ego_x-last_ego_x)
                theta +=delta
        ...
        if validationEnv2.final_x < ego_x-validationEnv2.initial_x:
            validationEnv2.Left_action = False
        else:
            validationEnv2.Left_action = True
        # print('validationEnv2.final_x(goal distance): ',validationEnv2.final_x)
        # print('ego_x-validationEnv2.initial_x(driven distance): ',ego_x-validationEnv2.initial_x)
    ...
    def LC_Right(self, action,v_target,c_target):
        ...
        if('ego' in vehs):  
            ...
            if action == 6:
                ...
                if validationEnv2.Right_action == False:
                    # print('validationEnv2.Right_action == False')
                    t = 0
                    validationEnv2.t_LC_start = traci.simulation.getTime()
                    validationEnv2.initial_x = ego_x
                    validationEnv2.initial_y = ego_y
                    ...
                    # print('validationEnv2.Right_action == True')
                    t= traci.simulation.getTime()-validationEnv2.t_LC_start                        
                    if path_done:
                        validationEnv2.coefficient = [target_y-ego_y,0,0,0]
                    if LC_succeed:                                                     
        ...
        if validationEnv2.final_x < ego_x-validationEnv2.initial_x:
            ...
            validationEnv2.Right_action = True
        # print('validationEnv2.final_x(goal distance): ',validationEnv2.final_x)
        # print('ego_x-validationEnv2.initial_x(driven distance): ',ego_x-validationEnv2.initial_x)
    def other_mode_reset(self,action):
        for i in range(6):
            if i != action:
                validationEnv2.mode[i] = 0  
    ...
    def reset_left_right_target_vehicle(self):
        if traci.simulation.getTime() >= 0.03 and traci.vehicle.getLaneIndex('ego') == 1: # 기준이되는 옆차로 차량을 시뮬레이션 시작할 때 설정한다. lane 0,2(while LC) no reset
            ...
            right_vehicles.sort() 
            vehs = traci.vehicle.getIDList()
            # if (validationEnv2.Target_left_car and 'car.left'+str(int(validationEnv2.Target_left_car[-1])-2) in vehs and 'car.left'+str(int(validationEnv2.Target_left_car[-1])-1) in vehs and 'car.left'+str(int(validationEnv2.Target_left_car[-1])+1) in vehs and 'car.left'+str(int(validationEnv2.Target_left_car[-1])+2) in vehs):
            if (validationEnv2.Target_left_car and 'car.left0' in vehs and 'car.left1' in vehs and 'car.left2' in vehs and 'car.left3' in vehs and 'car.left4' in vehs and 'car.left5' in vehs and 'car.left6' in vehs and 'car.left7' in vehs):
                if validationEnv2.Target_left_car != left_vehicles[0][1]:    
                    if int(validationEnv2.Target_left_car[-1]) < int(left_vehicles[0][1][-1]):
                        self.remove_last_SD_visualization(traci.vehicle.getFollower(validationEnv2.Target_left_car)[0],validationEnv2.Target_left_car)
                    else:
                        self.remove_last_SD_visualization(validationEnv2.Target_left_car,traci.vehicle.getLeader(validationEnv2.Target_left_car)[0])
            # if (validationEnv2.Target_right_car and 'car.right'+str(int(validationEnv2.Target_right_car[-1])-2) in vehs and 'car.right'+str(int(validationEnv2.Target_right_car[-1])-1) in vehs and 'car.right'+str(int(validationEnv2.Target_right_car[-1])+1) in vehs and 'car.right'+str(int(validationEnv2.Target_right_car[-1])+2) in vehs):
            if (validationEnv2.Target_right_car and 'car.right0' in vehs and 'car.right1' in vehs and 'car.right2' in vehs and 'car.right3' in vehs and 'car.right4' in vehs and 'car.right5' in vehs and 'car.right6' in vehs and 'car.right7' in vehs):
                if validationEnv2.Target_right_car != right_vehicles[0][1]:
                    if int(validationEnv2.Target_right_car[-1]) < int(right_vehicles[0][1][-1]):
                        self.remove_last_SD_visualization(traci.vehicle.getFollower(validationEnv2.Target_right_car)[0],validationEnv2.Target_right_car)
                    else:
                        self.remove_last_SD_visualization(validationEnv2.Target_right_car,traci.vehicle.getLeader(validationEnv2.Target_right_car)[0])
            validationEnv2.Target_left_car = left_vehicles[0][1]
            validationEnv2.Target_right_car = right_vehicles[0][1]
            # print('New Target_left_car: ',validationEnv2.Target_left_car)
            # print('New Target_right_car: ',validationEnv2.Target_right_car)
    ...
    def RuleBasedResult(self):
        ...
        # s1_back = (self.vehicle_position(validationEnv2.Target_left_car)[0] + self.SD_LC_with_respect_to_target_space('ego',1,'back')) #자차와 왼쪽 차로 옆차량 SD_LC 위치
        # s2_back = (self.vehicle_position(validationEnv2.Target_right_car)[0] + self.SD_LC_with_respect_to_target_space('ego',2,'back'))   
        # s3_front = (self.vehicle_position(validationEnv2.Target_left_car)[0] - self.SD_LC_with_respect_to_target_space('ego',3,'front'))           
        # s4_front = (self.vehicle_position(validationEnv2.Target_right_car)[0] - self.SD_LC_with_respect_to_target_space('ego',4,'front')) 
        ...
        if validationEnv2.Target_left_car in vehs and validationEnv2.Target_right_car in vehs and 'ego' in vehs:
            ...
            space1 = (self.vehicle_position(validationEnv2.Target_left_car)[0] + self.vehicle_position(left_leader)[0])/2
            space2 = (self.vehicle_position(validationEnv2.Target_right_car)[0] + self.vehicle_position(right_leader)[0])/2
            space3 = (self.vehicle_position(validationEnv2.Target_left_car)[0] + self.vehicle_position(left_follower)[0])/2
            space4 = (self.vehicle_position(validationEnv2.Target_right_car)[0] + self.vehicle_position(right_follower)[0])/2
            Safe_space1 = s1_front-s1_back
            Safe_space2 = s2_front-s2_back
            Safe_space3 = s3_front-s3_back
            Safe_space4 = s4_front-s4_back
        else:
            s1_back= validationEnv2.S[1]
            s1_front = validationEnv2.S[5]
            s2_back= validationEnv2.S[2]
            s2_front= validationEnv2.S[6]
            s3_front= validationEnv2.S[3]
            s3_back= validationEnv2.S[7]
            s4_front= validationEnv2.S[4]
            s4_back= validationEnv2.S[8]
            space1 = validationEnv2.last_Space1
            space2 = validationEnv2.last_Space2
            space3 = validationEnv2.last_Space3
            space4 = validationEnv2.last_Space4
            Safe_space1 = validationEnv2.last_Safe_Space1
            Safe_space2 = validationEnv2.last_Safe_Space2
            Safe_space3 = validationEnv2.last_Safe_Space3
            Safe_space4 = validationEnv2.last_Safe_Space4
            left_leader, left_follower, right_leader, right_follower = self.reset_left_right_target_vehicle()
        ...
        ego_chosen_space = None
        if ego_x< self.vehicle_position(left_leader)[0] and ego_x>self.vehicle_position(validationEnv2.Target_left_car)[0] and traci.vehicle.getLaneIndex('ego') == 2:
            ego_chosen_space =1
        if ego_x< self.vehicle_position(right_leader)[0] and ego_x>self.vehicle_position(validationEnv2.Target_right_car)[0] and traci.vehicle.getLaneIndex('ego') == 0:
            ego_chosen_space =2
        if ego_x< self.vehicle_position(validationEnv2.Target_left_car)[0] and ego_x>self.vehicle_position(left_follower)[0] and traci.vehicle.getLaneIndex('ego') == 2:
            ego_chosen_space =3
        if ego_x< self.vehicle_position(validationEnv2.Target_right_car)[0] and ego_x>self.vehicle_position(right_follower)[0] and traci.vehicle.getLaneIndex('ego') == 0:
            ego_chosen_space =4
        #t1
        if ego_x > s1_front:
            validationEnv2.ego_at_Target[0] =False
            # print('s1_1st')
            ...
            validationEnv2.ego_at_Target[0] =True            
            # print('s1_2nd')
            v_t = (traci.vehicle.getSpeed(left_leader) +traci.vehicle.getSpeed(validationEnv2.Target_left_car))/2
            mid = (self.vehicle_position(left_leader)[0] +self.vehicle_position(validationEnv2.Target_left_car)[0])/2
            # if ego_x>mid:
            ...
            validationEnv2.ego_at_Target[0] =False
            # print('s1_3rd')
            v_t = traci.vehicle.getSpeed(validationEnv2.Target_left_car)
        ...
        ##t2
        if ego_x > s2_front:
            validationEnv2.ego_at_Target[1] =False
            # print('s2_1st')
            ...
            validationEnv2.ego_at_Target[1] =True
            # print('s2_2nd')
            v_t = (traci.vehicle.getSpeed(right_leader) +traci.vehicle.getSpeed(validationEnv2.Target_right_car))/2
            mid = (self.vehicle_position(right_leader)[0] +self.vehicle_position(validationEnv2.Target_right_car)[0])/2
            # if ego_x>mid:
            #     print('s2_2nd_1')
            #     s = ego_x - mid
            #     t2 = (-v_ego-math.sqrt(v_ego**2+2*ego_decel*s))/ego_decel
            ...
            validationEnv2.ego_at_Target[1] =False
            # print('s2_3rd')
            v_t = traci.vehicle.getSpeed(validationEnv2.Target_right_car)
            s = s2_back-ego_x
            # t2 = (-v_ego+math.sqrt(v_ego**2+2*ego_accel*s))/ego_accel
            v0 = np.abs(v_ego - v_t)
        ...
        #t3                  
        if ego_x > s3_front:
            validationEnv2.ego_at_Target[2] =False
            # print('s3_1st')      
            v_t = traci.vehicle.getSpeed(validationEnv2.Target_left_car)
            ...
            validationEnv2.ego_at_Target[2] =True
            # print('s3_2nd')
            v_t = (traci.vehicle.getSpeed(left_leader)+traci.vehicle.getSpeed(validationEnv2.Target_left_car))/2
            mid = (self.vehicle_position(validationEnv2.Target_left_car)[0] +self.vehicle_position(left_follower)[0])/2
            # if ego_x>mid:
        ...
        #t4    
        if ego_x > s4_front: 
            validationEnv2.ego_at_Target[3] =False
            # print('s4_1st')         
            v_t = traci.vehicle.getSpeed(validationEnv2.Target_right_car)
            ...
            validationEnv2.ego_at_Target[3] =True
            # print('s4_2nd')
            v_t = (traci.vehicle.getSpeed(right_leader)+traci.vehicle.getSpeed(validationEnv2.Target_right_car))/2
            mid = (self.vehicle_position(validationEnv2.Target_right_car)[0] +self.vehicle_position(right_follower)[0])/2
            # if ego_x>mid:
        ...
        # if validationEnv2.last_target_space[0] != [0,0]:
        ...
        #     x_final = 0
        # print('x_final: ',x_final)
        # print('validationEnv2.coefficient: ',validationEnv2.coefficient)
        for idx,value in enumerate(validationEnv2.ego_at_Target):
            if value == 1:
                if validationEnv2.x_final != 0:
                    T_LC_continue[idx],_ = self.calculate_LC_time(validationEnv2.coefficient, validationEnv2.x_final, v_ego)           
        ...
        for idx, time in enumerate(T_avoidance):
            ...
            # else:
            #     result[idx] = False
            if validationEnv2.mode[idx] == 1 and traci.vehicle.getLaneIndex('ego')!=1:
                result[idx] = True
        Rear_clearance_threshold = 100 
        TTC_R_threshold = 15
        if rear_relative_distance>=Rear_clearance_threshold or TTC_R>TTC_R_threshold or validationEnv2.rear_collision_mode == 0:
            return 5
    ...
    def confusion_matrix_data_collection(self,episode): #Collect the data of Rule best space and RL action 
        ...
        df_Rule_RL = pd.DataFrame(validationEnv2.Rule_RL,columns=col_Rule_RL)
    ...
    def step(self, action): #action-> 0: LK_const_vel, 1: LK_accel, 2: LK_decel
        # print('final_y: ', validationEnv2.final_y)
        ...
        # validationEnv2.vehicles_tau[1] =2.27 ##### RL 검증 space 3
        # validationEnv2.vehicles_tau[4] =2.27 #space1
        validationEnv2.vehicles_tau[2] =2.27
        validationEnv2.vehicles_tau[3] =2.27 #space 4
        validationEnv2.vehicles_tau[11] =2.27 #space 2
        validationEnv2.vehicles_tau[12] =2.27 
        validationEnv2.vehicles_tau[13] =2.27 
        validationEnv2.vehicles_tau[14] =2.27 
        validationEnv2.vehicles_tau[15] =2.27 
        validationEnv2.vehicles_tau[16] =2.27
        # vehs = traci.vehicle.getIDList()
        traci.simulationStep()
        ...
        if traci.simulation.getTime() > 0.03 and ('car.forward' not in vehs):
            ...
            # sys.stdout.flush()
        # print('validationEnv2.Target_right_car: ',validationEnv2.Target_right_car)
        # print('validationEnv2.Target_left_car: ',validationEnv2.Target_left_car)
        ...
        if traci.simulation.getTime() == 0.03: # 기준이되는 옆차로 차량을 시뮬레이션 시작할 때 설정한다.(-> 후방 차량의 추돌 위험이 감지 될 때 마다 기준이 되는 옆차로 차량의 위치를 갱신하는게 맞다.)
            ...
            validationEnv2.Target_left_car = left_vehicles[0][1]
            validationEnv2.Target_right_car = right_vehicles[0][1]
            print('Initial Target_left_car: ',validationEnv2.Target_left_car)
            print('Initial Target_right_car: ',validationEnv2.Target_right_car)
            traci.vehicle.unsubscribeContext('ego', tc.CMD_GET_VEHICLE_VARIABLE, 120.0)
        ...
        if len(validationEnv2.ego) !=0:
            ego_v_last = validationEnv2.ego[-1][4]
        else:
        ...
        if('ego' in vehs and 'car.forward' in vehs and 'accel.rear' in vehs): 
            ...
            if self.gui_on:
                ...
                self.SD_visualization(validationEnv2.Target_left_car,self.SD_LC_with_respect_to_target_space('ego',1,'back'),'front','LC')
                self.SD_visualization(left_leader,self.SD_LC_with_respect_to_target_space('ego',1,'front'),'back','LC')
                self.SD_visualization(validationEnv2.Target_right_car,self.SD_LC_with_respect_to_target_space('ego',2,'back'),'front','LC')
                ...
                self.SD_visualization(validationEnv2.Target_left_car,self.SD_LC_with_respect_to_target_space('ego',3,'front'),'back','LC')
                self.SD_visualization(right_follower,self.SD_LC_with_respect_to_target_space('ego',4,'back'),'front','LC')
                self.SD_visualization(validationEnv2.Target_right_car,self.SD_LC_with_respect_to_target_space('ego',4,'front'),'back','LC')
            ...
            if action == 0: # LK mode delay collision (collision mitigation)
                ...
                self.other_mode_reset(action)
                if validationEnv2.last_action[-1][1] != 1:
                    validationEnv2.Left_action = False 


                if ego_x >= s1_back+epsilon and ego_x <= s1_front-epsilon: # LC 모드 진입 조건
                    validationEnv2.mode[1] = 2 #LC mode

                elif (ego_x< s1_back+epsilon or ego_x>s1_front-epsilon) and validationEnv2.mode[1] !=2:
                    validationEnv2.mode[1] = 1
                
                if ego_x < s1_back or ego_x > s1_front: # LC 모드 탈출,(preLC 모드 재진입조건)
                    # print(':::::::::::::::::::::::preLC 조건')
                    validationEnv2.mode[1] = 1 #preLC mode

                if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s1_back and traci.vehicle.getLaneIndex('ego')==1: 
                    # print(':::::::::::::::::::::::LC 탈출 조건')
                    validationEnv2.mode[1] = 1

                if validationEnv2.mode[1] == 1:                   
                    if ego_x > s1_front -epsilon:
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s1_front - epsilon:                        
                            ...
                            # v_t = max(min(traci.vehicle.getSpeed(left_leader),traci.vehicle.getSpeed(Forward_id)),traci.vehicle.getSpeed(validationEnv2.Target_left_car))
                            v_t = traci.vehicle.getSpeed(left_leader)
                            c_t = s1_front - epsilon
                            if self.gui_on:
                                self.Target_point_visualization(left_leader,[s1_front - epsilon,self.vehicle_position(left_leader)[1]])
                        validationEnv2.Target1.append([traci.simulation.getTime(),1,s1_front,space1,v_t]) 
                        # print([0,1,0,0,0,0])
                        ...
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s1_back+epsilon:
                            ...
                            c_t = s1_back+epsilon
                            if self.gui_on:
                                self.Target_point_visualization(validationEnv2.Target_left_car,[s1_back+epsilon,self.vehicle_position(validationEnv2.Target_left_car)[1]])
                        validationEnv2.Target1.append([traci.simulation.getTime(),1,s1_back,space1,v_t]) 
                        # print([0,1,0,0,0,0])
                ...
                if validationEnv2.mode[1] == 2:
                    ...
                    if (traci.vehicle.getLaneIndex('ego') == 1):
                        if(self.vehicle_position('car.forward')[0]-ego_x<SD_LK_forward):
                            ...
                            v_t = (b*traci.vehicle.getSpeed(validationEnv2.Target_left_car)+a*traci.vehicle.getSpeed('car.forward'))/(a+b)
                            c_t = s1_back+epsilon+a/(a+b)*(self.vehicle_position('car.forward')[0]-SD_LK_forward -(s1_back+epsilon))- ego_x
                            if self.gui_on:
                                self.Target_point_visualization('weighted_point_with_Forward',[s1_back+epsilon+a/(a+b)*(self.vehicle_position('car.forward')[0]-SD_LK_forward -(s1_back+epsilon)),self.vehicle_position(validationEnv2.Target_left_car)[1]])
                        else:
                            a = ego_x - (s1_back+epsilon)
                            b = s1_front-epsilon - ego_x
                            v_t = (b*traci.vehicle.getSpeed(validationEnv2.Target_left_car)+a*traci.vehicle.getSpeed(left_leader))/(a+b)
                ...
                self.other_mode_reset(action)
                if validationEnv2.last_action[-1][1] != 2:
                    validationEnv2.Right_action = False 
                if ego_x >= s2_back+epsilon and ego_x<= s2_front-epsilon: #LC 모드 진입 조건
                    validationEnv2.mode[2] =2 #LC mode
                elif (ego_x< s2_back+epsilon or ego_x>s2_front-epsilon) and validationEnv2.mode[2] !=2:
                    validationEnv2.mode[2] = 1
                if ego_x < s2_back or ego_x > s2_front: #LC 모드 탈출,(preLC 모드 재진입조건)
                    # print(':::::::::::::::::::::::preLC 조건')
                    validationEnv2.mode[2] = 1 #preLC mode
                if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s2_back and traci.vehicle.getLaneIndex('ego')==1: 
                    # print(':::::::::::::::::::::::LC 탈출 조건')
                    validationEnv2.mode[2] = 1
                if validationEnv2.mode[2] == 1:  
                    if ego_x > s2_front -epsilon:
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s2_front - epsilon:
                            ...
                            # v_t = max(min(traci.vehicle.getSpeed(right_leader),traci.vehicle.getSpeed(Forward_id)),traci.vehicle.getSpeed(validationEnv2.Target_right_car))
                            v_t = traci.vehicle.getSpeed(right_leader)
                            c_t = s2_front - epsilon
                            if self.gui_on:
                                self.Target_point_visualization(right_leader,[s2_front - epsilon,self.vehicle_position(right_leader)[1]])
                        validationEnv2.Target2.append([traci.simulation.getTime(),2,s2_front,space2,v_t]) 
                        # print([0,0,1,0,0,0]) 
                        ...
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s2_back+epsilon:
                            ...
                            c_t = s2_back+epsilon
                            if self.gui_on:
                                self.Target_point_visualization(validationEnv2.Target_right_car,[s2_back+epsilon,self.vehicle_position(validationEnv2.Target_right_car)[1]])
                        validationEnv2.Target2.append([traci.simulation.getTime(),2,s2_back,space2,v_t]) 
                        # print([0,0,1,0,0,0])
                ...
                if validationEnv2.mode[2] == 2:
                    # print([0,0,2,0,0,0])
                    if (traci.vehicle.getLaneIndex('ego') == 1):
                        if(self.vehicle_position('car.forward')[0]-ego_x<SD_LK_forward):
                            a = ego_x -(s2_back + epsilon)
                            b = ego_x - (self.vehicle_position('car.forward')[0]-SD_LK_forward)
                            v_t = (b*traci.vehicle.getSpeed(validationEnv2.Target_right_car)+a*traci.vehicle.getSpeed('car.forward'))/(a+b)
                            c_t = s2_back+epsilon+a/(a+b)*(self.vehicle_position('car.forward')[0]-SD_LK_forward -(s2_back+epsilon))- ego_x
                            if self.gui_on:
                                self.Target_point_visualization('weighted_point_with_Forward',[s2_back+epsilon+a/(a+b)*(self.vehicle_position('car.forward')[0]-SD_LK_forward -(s2_back+epsilon)),self.vehicle_position(validationEnv2.Target_right_car)[1]])
                        else:
                            a = ego_x - (s2_back+epsilon)
                            b = s2_front-epsilon - ego_x
                            v_t = (b*traci.vehicle.getSpeed(validationEnv2.Target_right_car)+a*traci.vehicle.getSpeed(right_leader))/(a+b)
                ...
                self.other_mode_reset(action)   
                if validationEnv2.last_action[-1][1] != 3:
                    validationEnv2.Left_action = False
                if ego_x >= s3_back+epsilon and ego_x <= s3_front-epsilon: # LC 모드 진입 조건
                    validationEnv2.mode[3] = 2 #LC mode
                elif (ego_x< s3_back+epsilon or ego_x>s3_front-epsilon) and validationEnv2.mode[3] !=2:
                    validationEnv2.mode[3] = 1
                if ego_x < s3_back or ego_x > s3_front: # LC 모드 탈출,(preLC 모드 재진입조건)
                    # print(':::::::::::::::::::::::preLC 조건')
                    validationEnv2.mode[3] = 1 #preLC mode
                if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s3_back and traci.vehicle.getLaneIndex('ego')==1: 
                    # print(':::::::::::::::::::::::LC 탈출 조건')
                    validationEnv2.mode[3] = 1

                if validationEnv2.mode[3] == 1:                   
                    if ego_x > s3_front -epsilon:
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s3_front - epsilon:
                            ...
                            if self.gui_on:
                                self.Target_point_visualization(left_leader,[s3_front - epsilon,self.vehicle_position(validationEnv2.Target_left_car)[1]])
                        validationEnv2.Target3.append([traci.simulation.getTime(),3,s3_front,space3,v_t]) 
                        # print([0,0,0,1,0,0])
                        ...
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s3_back+epsilon:
                            ...
                            v_t = max(min(traci.vehicle.getSpeed(validationEnv2.Target_left_car),traci.vehicle.getSpeed(Forward_id)),traci.vehicle.getSpeed(left_follower))
                            c_t = s3_back+epsilon
                            if self.gui_on:
                                self.Target_point_visualization(left_follower,[s3_back+epsilon,self.vehicle_position(left_follower)[1]])
                        validationEnv2.Target3.append([traci.simulation.getTime(),3,s3_back,space3,v_t]) 
                        # print([0,0,0,1,0,0])
                ...
                if validationEnv2.mode[3] == 2:
                    ...
                    if (traci.vehicle.getLaneIndex('ego') == 1):
                        if(self.vehicle_position('car.forward')[0]-ego_x<SD_LK_forward):
                            ...
                            v_t = (b*traci.vehicle.getSpeed(left_follower)+a*traci.vehicle.getSpeed(validationEnv2.Target_left_car))/(a+b)
                            c_t = s3_front - epsilon - ego_x
                            if self.gui_on:
                                self.Target_point_visualization(validationEnv2.Target_left_car,[s3_front - epsilon,self.vehicle_position(validationEnv2.Target_left_car)[1]])
                    else: # laneindex == 2 (TargetLane)
                        a = ego_x - (s3_back+epsilon)
                        b = s3_front-epsilon - ego_x
                        v_t = (b*traci.vehicle.getSpeed(left_follower)+a*traci.vehicle.getSpeed(validationEnv2.Target_left_car))/(a+b)
                ...
                if validationEnv2.last_action[-1][1] != 4:
                    validationEnv2.Right_action = False 
                if ego_x >= s4_back+epsilon and ego_x <= s4_front-epsilon: # LC 모드 진입 조건
                    validationEnv2.mode[4] = 2 #LC mode
                elif (ego_x< s4_back+epsilon or ego_x>s4_front-epsilon) and validationEnv2.mode[4] !=2:
                    validationEnv2.mode[4] = 1
                if ego_x < s4_back or ego_x > s4_front: # LC 모드 탈출,(preLC 모드 재진입조건)
                    # print(':::::::::::::::::::::::preLC 조건')
                    validationEnv2.mode[4] = 1 #preLC mode
                if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s4_back and traci.vehicle.getLaneIndex('ego')==1: 
                    # print(':::::::::::::::::::::::LC 탈출 조건')
                    validationEnv2.mode[4] = 1

                if validationEnv2.mode[4] == 1:                   
                    if ego_x > s4_front -epsilon:
                        if self.vehicle_position(Forward_id)[0] - SD_LK_forward <= s4_front - epsilon:
                            ...
                            # v_t = max(min(traci.vehicle.getSpeed(validationEnv2.Target_right_car),traci.vehicle.getSpeed(Forward_id)),traci.vehicle.getSpeed(right_follower))
                            v_t = traci.vehicle.getSpeed(validationEnv2.Target_right_car)
                            c_t = s4_front - epsilon
                            if self.gui_on:
                                self.Target_point_visualization(validationEnv2.Target_right_car,[s4_front - epsilon,self.vehicle_position(validationEnv2.Target_right_car)[1]])
                        validationEnv2.Target4.append([traci.simulation.getTime(),4,s4_front,space4,v_t]) 
                        # print([0,0,0,0,1,0])
                        ...
                        validationEnv2.Target4.append([traci.simulation.getTime(),4,s4_back,space4,v_t]) 
                        # print([0,0,0,0,1,0])
                ...
                if validationEnv2.mode[4] == 2:
                    ...
                    if (traci.vehicle.getLaneIndex('ego') == 1):
                        if(self.vehicle_position('car.forward')[0]-ego_x<SD_LK_forward):
                            ...
                            v_t = (b*traci.vehicle.getSpeed(right_follower)+a*traci.vehicle.getSpeed(validationEnv2.Target_right_car))/(a+b)
            ...
            validationEnv2.last_Space1=space1
            validationEnv2.last_Space2=space2
            validationEnv2.last_Space3=space3
            validationEnv2.last_Space4=space4
            validationEnv2.S = [0,s1_back,s2_back,s3_front,s4_front,s1_front,s2_front,s3_back,s4_back]
        ...
        validationEnv2.Rule_RL.append([traci.simulation.getTime(),self.RuleBasedResult(),action])  
        ...
        for veh_id in vehs:
            ...
            if traci.vehicle.getRoadID(veh_id) == 'E5': 
                ...
                ID = veh_id.split('.')
                velocity_y=0
                if veh_id== 'ego' and not (len(validationEnv2.ego)==0):
                    velocity_y = (y1 - validationEnv2.ego[-1][3])/self.step_length
                if veh_id== 'car.left0' and not (len(validationEnv2.left0))==0:
                    velocity_y = (y1 - validationEnv2.left0[-1][3])/self.step_length
                if veh_id== 'car.left1' and not (len(validationEnv2.left1))==0:
                    velocity_y = (y1 - validationEnv2.left1[-1][3])/self.step_length
                if veh_id== 'accel.rear' and not (len(validationEnv2.rear))==0:
                    velocity_y = (y1 - validationEnv2.rear[-1][3])/self.step_length
                if veh_id== 'car.right0' and not (len(validationEnv2.right0))==0:
                    velocity_y = (y1 - validationEnv2.right0[-1][3])/self.step_length
                if veh_id== 'car.right1' and not (len(validationEnv2.right1))==0:
                    velocity_y = (y1 - validationEnv2.right1[-1][3])/self.step_length
                if veh_id== 'car.left2' and not (len(validationEnv2.left2))==0:
                    velocity_y = (y1 - validationEnv2.left2[-1][3])/self.step_length
                if veh_id== 'car.left3' and not (len(validationEnv2.left3))==0:
                    velocity_y = (y1 - validationEnv2.left3[-1][3])/self.step_length
                if veh_id== 'car.left4' and not (len(validationEnv2.left4))==0:
                    velocity_y = (y1 - validationEnv2.left4[-1][3])/self.step_length
                if veh_id== 'car.left5' and not (len(validationEnv2.left5))==0:
                    velocity_y = (y1 - validationEnv2.left5[-1][3])/self.step_length
                if veh_id== 'car.left6' and not (len(validationEnv2.left6))==0:
                    velocity_y = (y1 - validationEnv2.left6[-1][3])/self.step_length
                if veh_id== 'car.left7' and not (len(validationEnv2.left7))==0:
                    velocity_y = (y1 - validationEnv2.left7[-1][3])/self.step_length
                if veh_id== 'car.forward' and not (len(validationEnv2.forward))==0:
                    velocity_y = (y1 - validationEnv2.forward[-1][3])/self.step_length
                if veh_id== 'car.right2' and not (len(validationEnv2.right2))==0:
                    velocity_y = (y1 - validationEnv2.right2[-1][3])/self.step_length
                if veh_id== 'car.right3' and not (len(validationEnv2.right3))==0:
                    velocity_y = (y1 - validationEnv2.right3[-1][3])/self.step_length
                if veh_id== 'car.right4' and not (len(validationEnv2.right4))==0:
                    velocity_y = (y1 - validationEnv2.right4[-1][3])/self.step_length
                if veh_id== 'car.right5' and not (len(validationEnv2.right5))==0:
                    velocity_y = (y1 - validationEnv2.right5[-1][3])/self.step_length
                if veh_id== 'car.right6' and not (len(validationEnv2.right6))==0:
                    velocity_y = (y1 - validationEnv2.right6[-1][3])/self.step_length
                if veh_id== 'car.right7' and not (len(validationEnv2.right7))==0:
                    velocity_y = (y1 - validationEnv2.right7[-1][3])/self.step_length
                ...
                acceleration_y=0
                if veh_id== 'ego' and not (len(validationEnv2.ego)==0):
                    acceleration_y = (velocity_y - validationEnv2.ego[-1][5])/self.step_length
                if veh_id== 'car.left0' and not (len(validationEnv2.left0))==0:
                    acceleration_y = (velocity_y- validationEnv2.left0[-1][5])/self.step_length
                if veh_id== 'car.left1' and not (len(validationEnv2.left1))==0:
                    acceleration_y = (velocity_y - validationEnv2.left1[-1][5])/self.step_length
                if veh_id== 'accel.rear' and not (len(validationEnv2.rear))==0:
                    acceleration_y = (velocity_y - validationEnv2.rear[-1][5])/self.step_length
                if veh_id== 'car.right0' and not (len(validationEnv2.right0))==0:
                    acceleration_y = (velocity_y - validationEnv2.right0[-1][5])/self.step_length
                if veh_id== 'car.right1' and not (len(validationEnv2.right1))==0:
                    acceleration_y = (velocity_y - validationEnv2.right1[-1][5])/self.step_length
                if veh_id== 'car.left2' and not (len(validationEnv2.left2))==0:
                    acceleration_y = (velocity_y - validationEnv2.left2[-1][5])/self.step_length
                if veh_id== 'car.left3' and not (len(validationEnv2.left3))==0:
                    acceleration_y = (velocity_y - validationEnv2.left3[-1][5])/self.step_length
                if veh_id== 'car.left4' and not (len(validationEnv2.left4))==0:
                    acceleration_y = (velocity_y - validationEnv2.left4[-1][5])/self.step_length
                if veh_id== 'car.left5' and not (len(validationEnv2.left5))==0:
                    acceleration_y = (velocity_y - validationEnv2.left5[-1][5])/self.step_length
                if veh_id== 'car.left6' and not (len(validationEnv2.left6))==0:
                    acceleration_y = (velocity_y - validationEnv2.left6[-1][5])/self.step_length
                if veh_id== 'car.left7' and not (len(validationEnv2.left7))==0:
                    acceleration_y = (velocity_y - validationEnv2.left7[-1][5])/self.step_length
                if veh_id== 'car.forward' and not (len(validationEnv2.forward))==0:
                    acceleration_y = (velocity_y - validationEnv2.forward[-1][5])/self.step_length
                if veh_id== 'car.right2' and not (len(validationEnv2.right2))==0:
                    acceleration_y = (velocity_y - validationEnv2.right2[-1][5])/self.step_length
                if veh_id== 'car.right3' and not (len(validationEnv2.right3))==0:
                    acceleration_y = (velocity_y - validationEnv2.right3[-1][5])/self.step_length
                if veh_id== 'car.right4' and not (len(validationEnv2.right4))==0:
                    acceleration_y = (velocity_y - validationEnv2.right4[-1][5])/self.step_length
                if veh_id== 'car.right5' and not (len(validationEnv2.right5))==0:
                    acceleration_y = (velocity_y - validationEnv2.right5[-1][5])/self.step_length
                if veh_id== 'car.right6' and not (len(validationEnv2.right6))==0:
                    acceleration_y = (velocity_y - validationEnv2.right6[-1][5])/self.step_length
                if veh_id== 'car.right7' and not (len(validationEnv2.right7))==0:
                    acceleration_y = (velocity_y - validationEnv2.right7[-1][5])/self.step_length
                ...
                if(veh_id == 'ego'):
                    validationEnv2.ego.append(vehicle_state)
                    # print(vehicle_state)
                if(veh_id =='car.left0'):
                    validationEnv2.left0.append(vehicle_state)
                if(veh_id=='car.left1'):
                    validationEnv2.left1.append(vehicle_state)
                if(veh_id=='accel.rear'):
                    validationEnv2.rear.append(vehicle_state)
                if(veh_id=='car.right0'):
                    validationEnv2.right0.append(vehicle_state)
                if(veh_id=='car.right1'):
                    validationEnv2.right1.append(vehicle_state)
                if(veh_id=='car.left2'):
                    validationEnv2.left2.append(vehicle_state)
                if(veh_id=='car.left3'):
                    validationEnv2.left3.append(vehicle_state)
                if(veh_id=='car.left4'):
                    validationEnv2.left4.append(vehicle_state)
                if(veh_id=='car.left5'):
                    validationEnv2.left5.append(vehicle_state)
                if(veh_id=='car.left6'):
                    validationEnv2.left6.append(vehicle_state)
                if(veh_id=='car.left7'):
                    validationEnv2.left7.append(vehicle_state)
                if(veh_id=='car.forward'):
                    validationEnv2.forward.append(vehicle_state)
                if(veh_id=='car.right2'):
                    validationEnv2.right2.append(vehicle_state)
                if(veh_id=='car.right3'):
                    validationEnv2.right3.append(vehicle_state)
                if(veh_id=='car.right4'):
                    validationEnv2.right4.append(vehicle_state)    
                if(veh_id=='car.right5'):
                    validationEnv2.right5.append(vehicle_state)   
                if(veh_id=='car.right6'):
                    validationEnv2.right6.append(vehicle_state)    
                if(veh_id=='car.right7'):
                    validationEnv2.right7.append(vehicle_state)   
            ...
            if veh_id == 'ego':
                if self.__ego_vehicle_LC_start() and traci.simulation.getTime()>=0.01:
                    ...
                    validationEnv2.ego_LC_start =True
                    traci.vehicle.setLaneChangeMode('ego',0)
                self.__ego_vehicle_LC_completed(action) # LC completed checking
                validationEnv2.lane_buffer_ego = traci.vehicle.getLaneIndex('ego') # ego_car lane buffer  
            ...
            if traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 'a':
                ...
                # if traci.vehicle.getSpeed('accel.rear') <= validationEnv2.rearMaxSpeed:
            ...
            if (traci.vehicle.getRoadID(veh_id) == 'E5' and veh_id[0] == 'c'):
                ...
                if veh_id == 'car.left0':
                    tau = validationEnv2.vehicles_tau[0]                    
                elif veh_id =='car.left1':
                    tau = validationEnv2.vehicles_tau[1]                    
                elif veh_id =='car.right0':
                    tau = validationEnv2.vehicles_tau[2]                    
                elif veh_id =='car.right1':
                    tau = validationEnv2.vehicles_tau[3]                    
                elif veh_id =='car.left2':
                    tau = validationEnv2.vehicles_tau[4]               
                elif veh_id =='car.left3':
                    tau = validationEnv2.vehicles_tau[5]                    
                elif veh_id =='car.left4':
                    tau = validationEnv2.vehicles_tau[6]
                elif veh_id =='car.left5':
                    tau = validationEnv2.vehicles_tau[7]
                elif veh_id =='car.left6':
                    tau = validationEnv2.vehicles_tau[8]
                elif veh_id =='car.left7':
                    tau = validationEnv2.vehicles_tau[9]
                elif veh_id =='car.forward':
                    tau = validationEnv2.vehicles_tau[10]                    
                elif veh_id =='car.right2':
                    tau = validationEnv2.vehicles_tau[11]                    
                elif veh_id =='car.right3':
                    tau = validationEnv2.vehicles_tau[12]                    
                elif veh_id =='car.right4':
                    tau = validationEnv2.vehicles_tau[13]
                elif veh_id =='car.right5':
                    tau = validationEnv2.vehicles_tau[14]
                elif veh_id =='car.right6':
                    tau = validationEnv2.vehicles_tau[15]
                elif veh_id =='car.right7':
                    tau = validationEnv2.vehicles_tau[16]
                else:
                    tau = 1.36
                ...
                if traci.vehicle.getLeader(veh_id) is not None: # 선행 차량이 있을 때 ACC
                    Leader_id,c_front = traci.vehicle.getLeader(veh_id)
                    v_preceding= traci.vehicle.getSpeed(Leader_id)
                    if Leader_id == 'ego'and validationEnv2.tau_random[int(veh_id[-1])] <= 0.5: # 50% 확률로 앞으로 끼어드는 ego vehicle 양보 x
                        tau = 0
                    c_desire = c0+tau*v_preceding
        ...
        # print(validationEnv2.step_num)
        ##### update Left Right Target Car #####
        # if 'ego'in vehs and validationEnv2.Target_left_car in vehs and validationEnv2.Target_right_car in vehs and traci.simulation.getTime()>0.03:
            
        #     last_target_left =''    
        #     last_target_right =''  
        #     if (traci.vehicle.getPosition('ego')[0]> traci.vehicle.getPosition(traci.vehicle.getLeader(validationEnv2.Target_left_car)[0])[0]):
        #         last_target_left = validationEnv2.Target_left_car
        #         validationEnv2.Target_left_car = traci.vehicle.getLeader(validationEnv2.Target_left_car)[0]                
        #         print('New Target_left_car: ',validationEnv2.Target_left_car)                
        #     if (traci.vehicle.getPosition('ego')[0]<traci.vehicle.getPosition(traci.vehicle.getFollower(validationEnv2.Target_left_car)[0])[0]):
        #         last_target_left = validationEnv2.Target_left_car
        #         validationEnv2.Target_left_car = traci.vehicle.getFollower(validationEnv2.Target_left_car)[0]                
        #         print('New Target_left_car: ',validationEnv2.Target_left_car)  
                
        #     if(traci.vehicle.getPosition('ego')[0]> traci.vehicle.getPosition(traci.vehicle.getLeader(validationEnv2.Target_right_car)[0])[0]):
        #         last_target_right = validationEnv2.Target_right_car
        #         validationEnv2.Target_right_car = traci.vehicle.getLeader(validationEnv2.Target_right_car)[0]
        #         print('New Target_right_car: ',validationEnv2.Target_right_car) 
        #     if(traci.vehicle.getPosition('ego')[0]<traci.vehicle.getPosition(traci.vehicle.getFollower(validationEnv2.Target_right_car)[0])[0]):
        #         last_target_right = validationEnv2.Target_right_car
        #         validationEnv2.Target_right_car = traci.vehicle.getFollower(validationEnv2.Target_right_car)[0]
        #         print('New Target_right_car: ',validationEnv2.Target_right_car)
        #     if last_target_left != '':
        #         polygon_ids = traci.polygon.getIDList()
        #         for polygon_id in polygon_ids:  
        ...
        if('ego' in vehs and 'car.forward' in vehs and 'accel.rear' in vehs):
            ...
            reward = self.__reward(validationEnv2.step_num, action) # rear vehicle collision : -10, collision caused by ego : -20, LC_succeed_with_biggest_space : +20, LC_succeed_with_smaller_space : +10, step*-0.01
        else:
            nextstate = validationEnv2.last_state ## it might wrong code
            self.done = True 
            reward = self.__reward(validationEnv2.step_num, action)
            if 'ego' not in vehs:
                print('no ego')
            if 'car.forward' not in vehs:
        ...
        validationEnv2.step_num +=1    
        self.ego_collision_happened()
        validationEnv2.last_action.append([traci.simulation.getTime(),action])
